    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "## Ejemplo 22: LCD-8bits. Lectura y medición del flag de busy\n\nAl apretar el pulsador se genera un ciclo de lectura en el LCD para leer el Flag de Busy  \nES NECESARIO QUE EL LCD esté previamente inicializado (Por ejemplo cargando el circuito 17)  \nSi está inicializado, se debe leer 0 en BF. Si no está inicializado BF estará a 1",
            "readonly": true
          },
          "position": {
            "x": -1024,
        ...
        {
          "id": "a99e6a0d-8a23-403c-9c99-685f03351cf3",
        ...
        {
          "id": "b981106b-a7aa-4169-a514-1fd229e63f16",
          "type": "basic.info",
          "data": {
            "info": "* rw=1: READ\n* rw=0: WRITE",
            "readonly": true
        ...
        {
          "id": "781fde59-4ca8-47de-9175-b808edc51f69",
          "type": "febcfed8636b8ee9a98750b96ed9e53a165dd4a8",
          "position": {
            "x": -968,
            "y": 832
        ...
        {
          "id": "374036f2-d348-408e-87d6-b2957d52d848",
          "type": "basic.info",
          "data": {
            "info": "BF se lee por el pin DB7 del  \nLCD (Mayor peso). Por eso, en los  \nciclos de lectura debe ser de ENTRADA  \ny en los ciclos de escritura de SALIDA",
            "readonly": true
          },
          "position": {
            "x": 448,
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "Configurar para ciclo de lectura",
            "readonly": true
          },
          "position": {
            "x": -968,
        ...
        {
          "id": "b5ec24f1-a035-41b1-b2e8-0d93e06894db",
          "type": "basic.info",
          "data": {
            "info": "Sacar un 1 por DB7 cuando  \nel pin es de salida",
            "readonly": true
          },
          "position": {
            "x": 224,
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "781fde59-4ca8-47de-9175-b808edc51f69",
        ...
        {
          "source": {
            "block": "a99e6a0d-8a23-403c-9c99-685f03351cf3",
            "port": "3d584b0a-29eb-47af-8c43-c0822282ef05"
          },
          "target": {
            "block": "ddc6665f-c600-4c99-8578-300574c6754a",
