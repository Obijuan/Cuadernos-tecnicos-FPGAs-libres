  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "27d84804-949d-4371-86ee-2307ae382f3e",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "virtual": false,
        ...
        {
          "id": "845bd9a9-9116-4104-8da1-da3baf78330c",
          "type": "basic.outputLabel",
          "data": {
            "name": "T02",
            "blockColor": "turquoise",
        ...
        {
          "id": "eb1ec804-07fb-4e43-9e04-40d0b87cc21d",
          "type": "basic.input",
          "data": {
            "name": "Boton",
            "virtual": false,
        ...
        {
          "id": "5fb8002e-89d5-4b06-ab79-38db7e551e49",
          "type": "basic.inputLabel",
          "data": {
            "name": "sw2",
            "blockColor": "darkgreen",
        ...
        {
          "id": "38003ffe-9430-4e74-b082-a5b0201e4c75",
          "type": "basic.inputLabel",
          "data": {
            "name": "T02",
            "blockColor": "turquoise",
        ...
        {
          "id": "21bda925-b6d2-4e20-8611-9baf7f6138c5",
          "type": "basic.outputLabel",
          "data": {
            "name": "sw2",
            "blockColor": "darkgreen",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# Ejemplo 2: LED ON/OFF\n\nEjemplo de implementación de un autómata con 2 estados y 2 transiciones. Inicialmente  \nel LED está apagado. Al apretar el pulsador `SW1` se enciende. Al apretar el pulsador  \n`SW2` se apaga",
            "readonly": true
          },
          "position": {
            "x": 136,
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "## Diagrama de estados\n\n![No image found...](https://github.com/Obijuan/Cuadernos-tecnicos-FPGAs-libres/raw/master/wiki/CT19-Automatas/Automata-2-estados-19-Ej-03-diagrama.svg)  ",
            "readonly": true
          },
          "position": {
            "x": 952,
        ...
        {
          "id": "f8835120-cfce-4d1d-858f-2193fd11285e",
          "type": "5018a67fe520592d7f82dbf669bb3c3661624b65",
          "position": {
            "x": 296,
            "y": 872
        ...
        {
          "id": "6456e62f-d1e4-4d0e-b3b9-c0e865bee005",
          "type": "ba518ee261a2be13a9739cd3a01cdcebe0ef63c0",
          "position": {
            "x": 800,
            "y": 896
        ...
        {
          "id": "bd343667-d346-456b-a243-27d652fcc79c",
          "type": "basic.info",
          "data": {
            "info": "Estamos en Estado 0 y se aprieta  \nel pulsador `SW1`",
            "readonly": true
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "27d84804-949d-4371-86ee-2307ae382f3e",
            "port": "in"
          }
        },
        {
        ...
        {
          "source": {
            "block": "f8835120-cfce-4d1d-858f-2193fd11285e",
            "port": "997db8c4-b772-49d8-83e7-4427aff720e6"
          },
          "target": {
            "block": "5fb8002e-89d5-4b06-ab79-38db7e551e49",
            "port": "inlabel"
          },
          "vertices": []
        },
        {
          "source": {
            "block": "eb1ec804-07fb-4e43-9e04-40d0b87cc21d",
            "port": "out"
          },
          "target": {
            "block": "f8835120-cfce-4d1d-858f-2193fd11285e",
        ...
        },
        {
          ...
          "target": {
            "block": "6456e62f-d1e4-4d0e-b3b9-c0e865bee005",
            "port": "18c2ebc7-5152-439c-9b3f-851c59bac834"
          },
          "vertices": []
        },
        {
          "source": {
            "block": "21bda925-b6d2-4e20-8611-9baf7f6138c5",
            "port": "outlabel"
          },
          "target": {
            "block": "6456e62f-d1e4-4d0e-b3b9-c0e865bee005",
        ...
        },
        {
          ...
          "target": {
            "block": "38003ffe-9430-4e74-b082-a5b0201e4c75",
            "port": "inlabel"
          },
          "vertices": []
        },
        ...
        {
          "source": {
            "block": "845bd9a9-9116-4104-8da1-da3baf78330c",
            "port": "outlabel"
          },
          "target": {
            "block": "2efa6274-fe7b-4229-a57c-f183b78812bd",
