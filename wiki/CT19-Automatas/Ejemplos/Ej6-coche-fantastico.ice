{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "9ae2e545-790a-493f-bf11-e6b63988a1cc",
          "type": "basic.inputLabel",
          "data": {
            "name": "EndR",
        ...
        {
          "id": "0eed5431-b8e8-4ab1-9559-4f4fc52b6413",
          "type": "basic.inputLabel",
          "data": {
            "name": "EndL",
            "blockColor": "darkgreen",
        ...
        {
          "id": "f6cefa20-49f7-47e0-b230-71f0ceefcf6d",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "virtual": false,
        ...
        {
          "id": "a36c72fa-c33a-45bf-b6d8-5371c4d3ea31",
          "type": "basic.outputLabel",
          "data": {
            "name": "time",
        ...
        {
          "id": "0b262e24-91f1-460d-baa7-0cf4f7a34279",
          "type": "basic.outputLabel",
          "data": {
            "name": "E0",
            "blockColor": "navy",
        ...
        {
          "id": "90ab01fd-dc80-4317-8bed-fa6ac0eb8831",
          "type": "basic.outputLabel",
          "data": {
            "name": "E1",
            "blockColor": "navy",
        ...
        {
          "id": "08683218-0288-442d-8a18-09bd70183009",
          "type": "basic.outputLabel",
          "data": {
            "name": "EndR",
            "blockColor": "darkgreen",
        ...
        {
          "id": "c7920ccf-542b-46e0-b8f5-5f828d0b183e",
          "type": "basic.outputLabel",
          "data": {
            "name": "E1",
            "blockColor": "navy",
        ...
        {
          "id": "a9d8e9f0-f042-4460-8273-b589f1c1b5f7",
          "type": "basic.outputLabel",
          "data": {
            "name": "EndL",
            "blockColor": "darkgreen",
        ...
        {
          "id": "f3359ab4-9b2c-4872-b616-2a673d8d6607",
          "type": "basic.inputLabel",
          "data": {
            "name": "time",
            "blockColor": "lightgray",
        ...
        {
          "id": "e18826c3-a36f-4681-984c-f04b51ac6974",
          "type": "basic.constant",
          "data": {
            "name": "ms",
            "value": "100",
        ...
        {
          "id": "03a8cfa7-41c5-4f34-914b-845012db8cb4",
          "type": "basic.constant",
          "data": {
            "name": "Inicial",
            "value": "'h80",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# Ejemplo 6: Coche fantastico (Knigh Rider)\n\nEjemplo de un circuito para generar la secuencia del coche fantástico (Knigh Rider)  \nen los LEDs. La ruta de datos está formada por un registro de desplazamiento   \nderecha-izquierda. El controlador es un autómada, que determina cuándo se debe ir en  \nun sentido o en otro",
            "readonly": true
          },
          "position": {
            "x": 152,
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "## Diagrama de estados\n\n![No image found...](https://github.com/Obijuan/Cuadernos-tecnicos-FPGAs-libres/raw/master/wiki/CT19-Automatas/Automata-2-estados-33-Ej-06-diagrama.svg)  ",
            "readonly": true
          },
          "position": {
            "x": 960,
        ...
        {
          "id": "ff32ea75-a852-47cc-971c-dc0624aa5a4d",
          "type": "71fb8cf8dca71c424eaef3f736ae6364c8626f29",
          "position": {
            "x": 992,
            "y": 496
          },
        ...
        {
          "id": "2120a6e4-0377-473e-a425-ef8ccefb577a",
        ...
        {
          "id": "1facb770-bf66-44a4-91f5-9424b33f9482",
        ...
        {
          "id": "dada4832-00ec-4acf-8464-fb9c90622def",
        ...
        {
          "id": "1e32baf7-66c4-416e-bac6-9fa8ed655365",
          "type": "ba518ee261a2be13a9739cd3a01cdcebe0ef63c0",
          "position": {
            "x": 296,
            "y": 800
        ...
        {
          "id": "22c21f66-5608-4a93-86dd-6780331b6cd6",
          "type": "basic.info",
          "data": {
            "info": "Transición T10",
            "readonly": true
        ...
        {
          "id": "18760e67-b364-43ff-8cad-98d1da351004",
          "type": "basic.info",
          "data": {
            "info": "## Ruta de datos",
            "readonly": true
        ...
        {
          "id": "232e83cb-72df-4f34-b73b-2ce2bddfa385",
          "type": "basic.info",
          "data": {
        ...
        {
          "id": "c900929d-3720-4bc6-a3f4-9386c8b0e9e2",
          "type": "basic.info",
          "data": {
            "info": "Temporización. Movimiento  \ndel LED",
            "readonly": true
          },
          "position": {
            "x": 992,
        ...
        {
          "id": "48740b6c-15f4-4fd5-b1ce-f7ea1245fd9d",
          "type": "basic.info",
          "data": {
        ...
        {
          "id": "68d2c982-5c4f-4983-8456-b60e9654a9f9",
          "type": "basic.info",
          "data": {
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "03a8cfa7-41c5-4f34-914b-845012db8cb4",
            "port": "constant-out"
          },
          "target": {
            "block": "ff32ea75-a852-47cc-971c-dc0624aa5a4d",
            "port": "9dad6350-1887-40ab-80e7-81fc57c7e5e7"
          }
        },
        {
          "source": {
            "block": "2120a6e4-0377-473e-a425-ef8ccefb577a",
        ...
        },
        {
          ...
          "target": {
            "block": "9ae2e545-790a-493f-bf11-e6b63988a1cc",
            "port": "inlabel"
          }
        },
        {
          ...
          "target": {
            "block": "0eed5431-b8e8-4ab1-9559-4f4fc52b6413",
            "port": "inlabel"
          }
        },
        {
          ...
          "target": {
            "block": "f6cefa20-49f7-47e0-b230-71f0ceefcf6d",
            "port": "in"
          },
          "size": 8
        },
        {
          "source": {
            "block": "e18826c3-a36f-4681-984c-f04b51ac6974",
            "port": "constant-out"
          },
          "target": {
            "block": "1facb770-bf66-44a4-91f5-9424b33f9482",
        ...
        },
        {
          ...
          "target": {
            "block": "f3359ab4-9b2c-4872-b616-2a673d8d6607",
            "port": "inlabel"
          }
        },
        {
          "source": {
            "block": "a36c72fa-c33a-45bf-b6d8-5371c4d3ea31",
            "port": "outlabel"
          },
          "target": {
            "block": "ff32ea75-a852-47cc-971c-dc0624aa5a4d",
        ...
        {
          "source": {
            "block": "0b262e24-91f1-460d-baa7-0cf4f7a34279",
            "port": "outlabel"
          },
          "target": {
            "block": "dada4832-00ec-4acf-8464-fb9c90622def",
            "port": "18c2ebc7-5152-439c-9b3f-851c59bac834"
          }
        },
        {
          "source": {
            "block": "08683218-0288-442d-8a18-09bd70183009",
            "port": "outlabel"
          },
          "target": {
            "block": "dada4832-00ec-4acf-8464-fb9c90622def",
        ...
        {
          "source": {
            "block": "90ab01fd-dc80-4317-8bed-fa6ac0eb8831",
            "port": "outlabel"
          },
          "target": {
            "block": "ff32ea75-a852-47cc-971c-dc0624aa5a4d",
        ...
        {
          "source": {
            "block": "c7920ccf-542b-46e0-b8f5-5f828d0b183e",
            "port": "outlabel"
          },
          "target": {
            "block": "1e32baf7-66c4-416e-bac6-9fa8ed655365",
            "port": "18c2ebc7-5152-439c-9b3f-851c59bac834"
          }
        },
        {
          "source": {
            "block": "a9d8e9f0-f042-4460-8273-b589f1c1b5f7",
            "port": "outlabel"
          },
          "target": {
            "block": "1e32baf7-66c4-416e-bac6-9fa8ed655365",
  ...
  "dependencies": {
    ...
    "71fb8cf8dca71c424eaef3f736ae6364c8626f29": {
      "package": {
        "name": "08-SLR",
        "version": "0.6",
        "description": "08-SLR: 8 bits shift left right register. Verilog implementation",
        "author": "Juan González-Gómez (Obijuan)",
