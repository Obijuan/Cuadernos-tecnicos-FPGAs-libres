    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# Ejemplo 1: LED OFF/ON\n\nEjemplo de implementación de un autómata con 2 estados y una única transición. Inicialmente  \nel LED está apagado. Al apretar el pulsador `SW1` se enciende",
            "readonly": true
          },
          "position": {
            "x": 176,
