  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "eb96bc6c-0bc9-40c0-a819-682b7e490eb1",
          "type": "basic.outputLabel",
          "data": {
            "name": "E1",
            "blockColor": "navy",
        ...
        {
          "id": "4daf222b-6fd8-45f0-8e38-d3e577fad7b2",
          "type": "basic.outputLabel",
          "data": {
            "name": "T12",
            "blockColor": "turquoise",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# Ejemplo 8: LED0 ó LED1 (II)\n\nEjemplo de implementación de un autómata de 3 estados.  Si se aprieta `SW1`  se  \nenciende el LED0. Si se vuelve a apretar `SW1`se enciende LED1 y se termina.  \nSi desde el estado inicial se aprieta `SW2` se  \nenciende el LED1 y se termina. Para volver al estado inicial hay que resetear la placa",
            "readonly": true
          },
          "position": {
            "x": 56,
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "## Diagrama de estados\n\n![No image found...](https://github.com/Obijuan/Cuadernos-tecnicos-FPGAs-libres/raw/master/wiki/CT19-Automatas/Automata-3-estados-Ej08-01-diagrama.svg)  ",
            "readonly": true
          },
          "position": {
            "x": 984,
        ...
        {
          "id": "c36c117e-288d-42ad-b1fb-48fd2a6a84a1",
        ...
        {
          "id": "142a7e5e-211f-4aa0-9b05-cf3819ea9a4f",
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "c36c117e-288d-42ad-b1fb-48fd2a6a84a1",
        ...
        },
        {
          ...
          "target": {
            "block": "142a7e5e-211f-4aa0-9b05-cf3819ea9a4f",
        ...
        {
          "source": {
            "block": "eb96bc6c-0bc9-40c0-a819-682b7e490eb1",
            "port": "outlabel"
          },
          "target": {
            "block": "564fbb64-311d-44db-aa7a-19a9f1363ebb",
        ...
        {
          "source": {
            "block": "4daf222b-6fd8-45f0-8e38-d3e577fad7b2",
            "port": "outlabel"
          },
          "target": {
            "block": "142a7e5e-211f-4aa0-9b05-cf3819ea9a4f",
