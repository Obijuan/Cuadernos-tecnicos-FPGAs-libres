  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "1d3c060b-88f1-4340-8418-729d0f431da2",
          "type": "basic.outputLabel",
          "data": {
            "name": "E0",
            "blockColor": "navy",
        ...
        {
          "id": "15fe3f40-9c9e-4436-a796-03627411a10b",
          "type": "basic.outputLabel",
          "data": {
            "name": "sw1",
            "blockColor": "fuchsia",
        ...
        {
          "id": "92602316-66e6-436b-9434-93a9bc8bfedc",
          "type": "basic.outputLabel",
          "data": {
            "name": "trig",
            "blockColor": "fuchsia",
        ...
        {
          "id": "a1a234bb-037d-43ae-8929-39247eb41399",
          "type": "basic.inputLabel",
          "data": {
            "name": "sw1",
            "blockColor": "fuchsia",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# Ejemplo 20: Generador de señal de 6Mhz con on/off\n\nCuando se aprieta el pulsador `sw1` se enciende el generador y produce una señal de 6 Mhz  \n(divisor entre dos). Si se aprieta de nuevo `sw1` se apaga. Se utiliza un autómata del  \nsistema con una bifurcación",
            "readonly": true
          },
          "position": {
            "x": -288,
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "## Diagrama de estados\n\n![No image found...](https://github.com/Obijuan/Cuadernos-tecnicos-FPGAs-libres/raw/master/wiki/CT19-Automatas/Aut-sys-10-Ej20-diagrama.svg)  ",
            "readonly": true
          },
          "position": {
            "x": 600,
        ...
        {
          "id": "bbd6a28d-0716-4eb1-9a42-1ee106bd4e1f",
        ...
        {
          "id": "56b710d1-6f6c-4dc7-879a-13a31be0785f",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "## Circuito de disparo y sincronizacion",
            "readonly": true
          },
          "position": {
            "x": 328,
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "Se empieza la captura si se había apretado  \nel pulsador y estamos en el estado `E0`",
            "readonly": true
          },
          "position": {
            "x": 592,
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "bbd6a28d-0716-4eb1-9a42-1ee106bd4e1f",
            "port": "4e8afe74-8f38-4873-97ee-f7585d99a4aa"
          },
          "target": {
            "block": "56b710d1-6f6c-4dc7-879a-13a31be0785f",
            "port": "97b51945-d716-4b6c-9db9-970d08541249"
          }
        },
        {
          "source": {
            "block": "1d3c060b-88f1-4340-8418-729d0f431da2",
            "port": "outlabel"
          },
          "target": {
            "block": "56b710d1-6f6c-4dc7-879a-13a31be0785f",
        ...
        {
          "source": {
            "block": "92602316-66e6-436b-9434-93a9bc8bfedc",
            "port": "outlabel"
          },
          "target": {
            "block": "bbd6a28d-0716-4eb1-9a42-1ee106bd4e1f",
        ...
        {
          "source": {
            "block": "15fe3f40-9c9e-4436-a796-03627411a10b",
            "port": "outlabel"
          },
          "target": {
            "block": "bbd6a28d-0716-4eb1-9a42-1ee106bd4e1f",
        ...
        },
        {
          ...
          "target": {
            "block": "a1a234bb-037d-43ae-8929-39247eb41399",
            "port": "inlabel"
          }
        },
        {
