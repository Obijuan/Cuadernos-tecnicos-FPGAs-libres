{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "992b08cb-407d-430f-9641-a522262362b7",
          "type": "basic.outputLabel",
          "data": {
            "name": "addr",
            "range": "[23:0]",
        ...
        {
          "id": "ecfe1150-561b-4d44-b899-c4c34b7e6f3f",
          "type": "basic.outputLabel",
          "data": {
            "name": "read",
            "blockColor": "navy",
        ...
        {
          "id": "947872d3-36f5-4b0e-92e1-d9a499a5820e",
          "type": "basic.inputLabel",
          "data": {
            "name": "read",
            "blockColor": "navy",
        ...
        {
          "id": "45e30299-e348-49d5-8def-3dc18c6df02a",
          "type": "basic.inputLabel",
          "data": {
            "name": "addr",
            "range": "[23:0]",
        ...
        {
          "id": "2008b49c-c09c-4612-bbf0-5abe7aecd94c",
          "type": "basic.input",
          "data": {
            "name": "Boton",
            "virtual": false,
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "## Ejemplo 15: Volcado manual de la flash en los LEDs\n\nSe vuelcan los byets de la flash, a partir de la dirección 0, en los LEDs. Con cada pulsación de `SW1`  \nse pasa a la siguiente dirección  \nEl patrón de bits a observar debe ser: FF 00 00 FF 7E AA 99 7E ...  ",
            "readonly": true
          },
          "position": {
            "x": -776,
        ...
        {
          "id": "dd1c9823-e388-4456-93aa-6cbe6eddc038",
        ...
        {
          "id": "c952a5f9-524e-4346-9ed1-e22fe21776d0",
        ...
        {
          "id": "b3caff71-4112-488f-ae3f-636e39b2826f",
          "type": "3d54c1a54a5279cef448f280d0db0986a6c3141a",
          "position": {
            "x": -160,
            "y": 232
          },
        ...
        {
          "id": "572955e6-09f7-48ab-9423-63472dad1d40",
          "type": "83a11ff9b54c979d8dcebf9983d0bf5d3652fe61",
          "position": {
            "x": -328,
            "y": 744
          },
        ...
        {
          "id": "460e46dc-0f62-4b1e-96aa-63c72feca9f0",
        ...
        {
          "id": "98bb5031-963d-47ab-944b-0b87b945e5c9",
          "type": "basic.info",
          "data": {
            "info": "Contador con la  \ndirección actual",
            "readonly": true
          },
          "position": {
            "x": -328,
        ...
        {
          "id": "dfc49bfb-6d12-49b8-ab8d-4e58abb877e3",
          "type": "basic.info",
          "data": {
            "info": "Tras incrementar el contador,  \nLeer de la nueva direccion",
            "readonly": true
          },
          "position": {
            "x": -248,
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "dd1c9823-e388-4456-93aa-6cbe6eddc038",
        ...
        {
          "source": {
            "block": "ecfe1150-561b-4d44-b899-c4c34b7e6f3f",
            "port": "outlabel"
          },
          "target": {
            "block": "dd1c9823-e388-4456-93aa-6cbe6eddc038",
        ...
        {
          "source": {
            "block": "2008b49c-c09c-4612-bbf0-5abe7aecd94c",
            "port": "out"
          },
          "target": {
            "block": "c952a5f9-524e-4346-9ed1-e22fe21776d0",
        ...
        {
          "source": {
            "block": "b3caff71-4112-488f-ae3f-636e39b2826f",
        ...
        {
          "source": {
            "block": "992b08cb-407d-430f-9641-a522262362b7",
            "port": "outlabel"
          },
          "target": {
            "block": "b3caff71-4112-488f-ae3f-636e39b2826f",
        ...
        },
        {
          ...
          "target": {
            "block": "572955e6-09f7-48ab-9423-63472dad1d40",
        ...
        },
        {
          "source": {
            "block": "572955e6-09f7-48ab-9423-63472dad1d40",
            "port": "ee1d2d35-88ba-4b28-a68c-5135ebc4be51"
          },
          "target": {
            "block": "45e30299-e348-49d5-8def-3dc18c6df02a",
            "port": "inlabel"
          },
          "size": 24
        },
        {
          ...
          "target": {
            "block": "460e46dc-0f62-4b1e-96aa-63c72feca9f0",
        ...
        },
        {
          ...
          "target": {
            "block": "947872d3-36f5-4b0e-92e1-d9a499a5820e",
            "port": "inlabel"
          }
        }
      ]
  ...
  "dependencies": {
    ...
    "3d54c1a54a5279cef448f280d0db0986a6c3141a": {
      "package": {
        "name": "flash-readid-bus CLONE",
        "version": "0.5-c1702499503438",
    ...
    "83a11ff9b54c979d8dcebf9983d0bf5d3652fe61": {
      "package": {
        "name": "Contador-basic",
        "version": "0.8",
        "description": "Contador básico, de 24 bits",
        "author": "Juan González-Gómez (Obijuan)",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "ee1d2d35-88ba-4b28-a68c-5135ebc4be51",
              "type": "basic.output",
              "data": {
                "name": "",
                "virtual": true,
          ...
          "wires": [
            ...
            },
            {
              ...
              "target": {
                "block": "ee1d2d35-88ba-4b28-a68c-5135ebc4be51",
                "port": "in"
              },
              "size": 24
            }
