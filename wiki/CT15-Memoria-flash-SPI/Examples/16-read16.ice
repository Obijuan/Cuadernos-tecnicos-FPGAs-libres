{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "41c0eaac-815b-44ef-8214-15bfeb321d1a",
        ...
        {
          "id": "cef4ea51-7de9-48f4-a8fa-0ba89757edbc",
          "type": "basic.inputLabel",
          "data": {
            "name": "dat",
            "range": "[15:0]",
        ...
        {
          "id": "8a49948b-559b-4d11-9bd1-469579abe76e",
          "type": "basic.inputLabel",
          "data": {
            "name": "done",
        ...
        {
          "id": "08a7b733-0554-45f4-bf55-405c2f2b6133",
          "type": "basic.outputLabel",
          "data": {
            "name": "done",
            "blockColor": "deepskyblue",
        ...
        {
          "id": "d511b128-6da3-4b36-ad5f-e63904593775",
          "type": "basic.outputLabel",
          "data": {
            "name": "start",
            "blockColor": "red",
        ...
        {
          "id": "4e60e6cd-a880-4d00-84e3-64cc6eb698ec",
          "type": "basic.outputLabel",
          "data": {
            "name": "dat",
            "range": "[15:0]",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "## Ejemplo 16: Lectura de la media-palabra (16-bits) de la dirección 0x000004\n\nAl apretar el pulsador `SW1` se envía el comando `READ` para leer la posición 0x00_00_04 de la flash \nSe lee de golpe un valor de 16 bits que se muestra en los 8 LEDs. Con el pulsador SW2 se seleccion qué byte ver (alto/ bajo)  \nEl valor leído debe ser `AA7E` (Little endian)",
            "readonly": true
          },
          "position": {
            "x": -112,
        ...
        {
          "id": "1f601ec9-dfbd-48e3-ab92-8401fe8ecb45",
        ...
        {
          "id": "b6a3543a-eccd-4e3d-8dd1-0e8d3d9e8f89",
          "type": "413b679cb6a3742086a1dbb6ba6ae1cdb8a66938",
          "position": {
            "x": 120,
            "y": 64
          },
        ...
        {
          "id": "d03f7957-0060-4445-8189-fe64581eab7e",
          "type": "basic.info",
          "data": {
            "info": "Media palabra  \nleída de la flash",
            "readonly": true
        ...
        {
          "id": "42d23112-13ac-4f36-9b86-04fd94187a5f",
          "type": "basic.info",
          "data": {
            "info": "## Mostrar la media palabra (16-bits)",
            "readonly": true
          },
          "position": {
            "x": 408,
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "4e60e6cd-a880-4d00-84e3-64cc6eb698ec",
            "port": "outlabel"
          },
          "target": {
        ...
        },
        {
          ...
          "target": {
            "block": "b6a3543a-eccd-4e3d-8dd1-0e8d3d9e8f89",
        ...
        },
        {
          ...
          "target": {
            "block": "cef4ea51-7de9-48f4-a8fa-0ba89757edbc",
            "port": "inlabel"
          },
          "size": 16
        },
        {
          ...
          "target": {
            "block": "8a49948b-559b-4d11-9bd1-469579abe76e",
            "port": "inlabel"
          }
        },
        {
          "source": {
            "block": "08a7b733-0554-45f4-bf55-405c2f2b6133",
            "port": "outlabel"
          },
          "target": {
        ...
        {
          "source": {
            "block": "d511b128-6da3-4b36-ad5f-e63904593775",
            "port": "outlabel"
          },
          "target": {
        ...
        {
          "source": {
            "block": "41c0eaac-815b-44ef-8214-15bfeb321d1a",
            "port": "outlabel"
          },
          "target": {
            "block": "b6a3543a-eccd-4e3d-8dd1-0e8d3d9e8f89",
        ...
        },
        {
          ...
          "target": {
            "block": "1f601ec9-dfbd-48e3-ab92-8401fe8ecb45",
  ...
  "dependencies": {
    ...
    "413b679cb6a3742086a1dbb6ba6ae1cdb8a66938": {
      "package": {
