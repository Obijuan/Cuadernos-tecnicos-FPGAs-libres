{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "6cadffbc-a9b1-42a6-bca1-827cabbb19fe",
          "type": "basic.output",
          "data": {
            "name": "Serial",
            "virtual": false,
        ...
        {
          "id": "7c5846e0-7e6d-4520-96c4-7b98855e6979",
          "type": "basic.info",
          "data": {
            "info": "Linea serie",
            "readonly": true
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "## Ejemplo 1: Transmisor de 0 bits\n\nCircuito que sólo deja la línea en reposo, sin transmitir  \nnada",
            "readonly": true
          },
          "position": {
            "x": 696,
        ...
        {
          "id": "6ee3a643-9088-4b95-a6be-e39607cde176",
      ...
      "wires": [
        {
          ...
          "target": {
            "block": "6ee3a643-9088-4b95-a6be-e39607cde176",
        ...
        },
        {
          ...
          "target": {
            "block": "6cadffbc-a9b1-42a6-bca1-827cabbb19fe",
            "port": "in"
          }
        },
        {
