{
    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# Transmisión de 6-bit \n\nSe envía el byte 0xc0 al apreta el pulsador SW1 y 0xff al apretar reset",
            "readonly": true
          },
          "position": {
            "x": -240,
        ...
        {
          "id": "cf76f1de-80c1-4315-bd0b-8cd5e04b2979",
          "type": "80ea21b3e49e571f3a87c0491a6a31637cb8f193",
          "position": {
            "x": 16,
            "y": 344
          },
        ...
        {
          "id": "3d66c735-6b30-4f19-84e6-cf856e907a5d",
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "3d66c735-6b30-4f19-84e6-cf856e907a5d",
        ...
        },
        {
          ...
          "target": {
            "block": "cf76f1de-80c1-4315-bd0b-8cd5e04b2979",
        ...
        },
        {
          ...
          "target": {
            "block": "cf76f1de-80c1-4315-bd0b-8cd5e04b2979",
            "port": "2adc0529-9300-46d3-869a-17c58f0d4ffc"
          },
          "vertices": [
            {
              "x": -40,
  ...
  "dependencies": {
    ...
    "80ea21b3e49e571f3a87c0491a6a31637cb8f193": {
      "package": {
        "name": "Sys-SR6-ld-rst-verilog",
        "version": "0.4",
        "description": "Sys-SR6-ld-rst-verilog: 6-bits System Shift register to the right, with load. Verilog implementation",
        "author": "Juan González-Gómez (Obijuan)",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "1ab502a2-848a-41b3-8727-4c11f6397338",
              "type": "basic.inputLabel",
              "data": {
                "name": "q",
                "range": "[5:0]",
            ...
            {
              "id": "1370a29f-b753-4911-b4c8-0be4bbb80567",
              "type": "basic.output",
              "data": {
                "name": "",
                "range": "[5:0]",
            ...
            {
              "id": "36ab03fa-744f-4475-98eb-39ff297211d3",
              "type": "basic.outputLabel",
              "data": {
                "name": "q",
                "range": "[5:0]",
            ...
            {
              "id": "969fe246-dc59-42ea-9cf5-45e667b61984",
              "type": "basic.outputLabel",
              "data": {
                "name": "d",
                "range": "[5:0]",
            ...
            {
              "id": "fddb6862-d10d-4bc0-a6dc-2ced354ba879",
              "type": "basic.inputLabel",
              "data": {
                "name": "d",
                "range": "[5:0]",
            ...
            {
              "id": "2adc0529-9300-46d3-869a-17c58f0d4ffc",
              "type": "basic.input",
              "data": {
                "name": "d",
                "range": "[5:0]",
          ...
          "wires": [
            ...
            },
            {
              ...
              "target": {
                "block": "1ab502a2-848a-41b3-8727-4c11f6397338",
                "port": "inlabel"
              },
              "size": 6
            },
            {
              "source": {
                "block": "969fe246-dc59-42ea-9cf5-45e667b61984",
                "port": "outlabel"
              },
              "target": {
                "block": "065d71ce-8cdc-4298-a5fe-42613b6d5d0a",
            ...
            {
              "source": {
                "block": "2adc0529-9300-46d3-869a-17c58f0d4ffc",
                "port": "out",
                "size": 6
              },
              "target": {
                "block": "fddb6862-d10d-4bc0-a6dc-2ced354ba879",
                "port": "inlabel"
              },
              "size": 6
            },
            {
              "source": {
                "block": "36ab03fa-744f-4475-98eb-39ff297211d3",
                "port": "outlabel"
              },
              "target": {
                "block": "1370a29f-b753-4911-b4c8-0be4bbb80567",
                "port": "in",
                "size": 6
              },
              "size": 6
