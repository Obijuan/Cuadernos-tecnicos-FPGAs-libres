{
    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# Transmisión de 16-bits \n\nSe envía el byte 0x00 al arrancar el circuito y al apretar el pulsador SW1",
            "readonly": true
          },
          "position": {
            "x": 216,
        ...
        {
          "id": "2f9a2ce9-e2cd-43ab-9641-1e7856548a77",
          "type": "cbf4043432764534556f9fe3ac74d405ea7348a1",
          "position": {
            "x": 432,
            "y": 392
          },
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "2f9a2ce9-e2cd-43ab-9641-1e7856548a77",
  ...
  "dependencies": {
    ...
    "cbf4043432764534556f9fe3ac74d405ea7348a1": {
      "package": {
        "name": "Sys-SR-rst-16-verilog",
        "version": "0.4",
        "description": "Sys-SR-rst-16-verilog: 16-bits System Shift register to the right, with reset.  Verilog implementation",
        "author": "Juan González-Gómez (Obijuan)",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "abe002ae-fac5-4f19-8cab-cb082ef7bb70",
              "type": "basic.output",
              "data": {
                "name": "",
                "range": "[15:0]",
          ...
          "wires": [
            ...
            },
            {
              ...
              "target": {
                "block": "abe002ae-fac5-4f19-8cab-cb082ef7bb70",
                "port": "in"
              },
              "size": 16
            }
