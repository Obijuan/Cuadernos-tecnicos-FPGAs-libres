{
    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# Transmisión de 4-bit \n\nSe envía el byte 0xf0 al apreta el pulsador SW1",
            "readonly": true
          },
          "position": {
            "x": 328,
        ...
        {
          "id": "560e956d-7ccd-46ec-a2c5-96550118dc57",
          "type": "5c1b5bf790eaea83ba6162e09b92541d2af6c239",
          "position": {
            "x": 600,
            "y": 392
          },
        ...
        {
          "id": "a9404ef1-832d-4d7d-b408-25a3c4271e83",
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "a9404ef1-832d-4d7d-b408-25a3c4271e83",
        ...
        },
        {
          ...
          "target": {
            "block": "560e956d-7ccd-46ec-a2c5-96550118dc57",
        ...
        },
        {
          ...
          "target": {
            "block": "560e956d-7ccd-46ec-a2c5-96550118dc57",
            "port": "2a2510bf-68b2-4881-98b6-3122cee78bf7"
          },
          "vertices": [
            {
              "x": 536,
  ...
  "dependencies": {
    ...
    "5c1b5bf790eaea83ba6162e09b92541d2af6c239": {
      "package": {
        "name": "Sys-SR4-ld-verilog",
        "version": "0.3",
        "description": "Sys-SR4-ld-verilog: 4-bits System Shift register to the right, with load. Verilog implementation",
        "author": "Juan González-Gómez (Obijuan)",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "6749f4eb-97ea-404e-8081-6e208cf20732",
              "type": "basic.outputLabel",
              "data": {
                "name": "q",
                "range": "[3:0]",
            ...
            {
              "id": "001627b6-e1a4-4821-b652-5012bba8a2a2",
              "type": "basic.output",
              "data": {
                "name": "",
                "range": "[3:0]",
            ...
            {
              "id": "1a829440-4a95-4c2a-9cb9-1b273cce0eea",
              "type": "basic.inputLabel",
              "data": {
                "name": "q",
                "range": "[3:0]",
            ...
            {
              "id": "9017778a-e8f6-4c15-8031-74282101486e",
              "type": "basic.outputLabel",
              "data": {
                "name": "d",
                "range": "[3:0]",
            ...
            {
              "id": "2a2510bf-68b2-4881-98b6-3122cee78bf7",
              "type": "basic.input",
              "data": {
                "name": "d",
                "range": "[3:0]",
            ...
            {
              "id": "3c752829-3a8d-41ba-bf65-ae7d551af01f",
              "type": "basic.inputLabel",
              "data": {
                "name": "d",
                "range": "[3:0]",
          ...
          "wires": [
            ...
            {
              "source": {
                "block": "9017778a-e8f6-4c15-8031-74282101486e",
                "port": "outlabel"
              },
              "target": {
                "block": "065d71ce-8cdc-4298-a5fe-42613b6d5d0a",
            ...
            },
            {
              ...
              "target": {
                "block": "1a829440-4a95-4c2a-9cb9-1b273cce0eea",
                "port": "inlabel"
              },
              "size": 4
            },
            {
              "source": {
                "block": "6749f4eb-97ea-404e-8081-6e208cf20732",
                "port": "outlabel"
              },
              "target": {
                "block": "001627b6-e1a4-4821-b652-5012bba8a2a2",
                "port": "in",
                "size": 4
              },
              "size": 4
            ...
            {
              "source": {
                "block": "2a2510bf-68b2-4881-98b6-3122cee78bf7",
                "port": "out",
                "size": 4
              },
              "target": {
                "block": "3c752829-3a8d-41ba-bf65-ae7d551af01f",
                "port": "inlabel"
              },
              "size": 4
            },
