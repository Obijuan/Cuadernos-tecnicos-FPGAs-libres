{
    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# Transmisión de 7-bit \n\nSe envía el byte 0x80 al apreta el pulsador SW1",
            "readonly": true
          },
          "position": {
            "x": -608,
        ...
        {
          "id": "8a965ecf-2553-49f3-9353-a6e2f9eb72e0",
          "type": "1804db92bd98f401de1ca907fcd61971388b72f5",
          "position": {
            "x": -384,
            "y": 336
          },
        ...
        {
          "id": "e9d3f8f4-dcd3-485d-9942-81da94db26d9",
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "e9d3f8f4-dcd3-485d-9942-81da94db26d9",
        ...
        },
        {
          ...
          "target": {
            "block": "8a965ecf-2553-49f3-9353-a6e2f9eb72e0",
  ...
  "dependencies": {
    ...
    "1804db92bd98f401de1ca907fcd61971388b72f5": {
      "package": {
        "name": "Sys-SR7-ld-verilog",
        "version": "0.3",
        "description": "Sys-SR7-ld-verilog: 7-bits System Shift register to the right, with load. Verilog implementation",
        "author": "Juan González-Gómez (Obijuan)",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "fff55ac5-098d-4efa-a60b-c4fe175d4857",
              "type": "basic.outputLabel",
              "data": {
                "name": "q",
                "range": "[6:0]",
            ...
            {
              "id": "e53c7562-9ef3-4c87-86ea-bfd233cc6430",
              "type": "basic.output",
              "data": {
                "name": "",
                "range": "[6:0]",
            ...
            {
              "id": "4e02b86e-ca5f-4c90-b363-9fec4ce7f435",
              "type": "basic.inputLabel",
              "data": {
                "name": "q",
                "range": "[6:0]",
            ...
            {
              "id": "693caeb1-368f-40be-b41c-0065ecd7d33e",
              "type": "basic.outputLabel",
              "data": {
                "name": "d",
                "range": "[6:0]",
            ...
            {
              "id": "04e6d6d4-1b61-4df6-a522-fe1b6daefabc",
              "type": "basic.inputLabel",
              "data": {
                "name": "d",
                "range": "[6:0]",
            ...
            {
              "id": "f472595e-1cf4-4657-bcff-0c1e65747068",
              "type": "basic.input",
              "data": {
                "name": "d",
                "range": "[6:0]",
          ...
          "wires": [
            ...
            },
            {
              ...
              "target": {
                "block": "4e02b86e-ca5f-4c90-b363-9fec4ce7f435",
                "port": "inlabel"
              },
              "size": 7
            },
            {
              "source": {
                "block": "693caeb1-368f-40be-b41c-0065ecd7d33e",
                "port": "outlabel"
              },
              "target": {
                "block": "065d71ce-8cdc-4298-a5fe-42613b6d5d0a",
            ...
            {
              "source": {
                "block": "fff55ac5-098d-4efa-a60b-c4fe175d4857",
                "port": "outlabel"
              },
              "target": {
                "block": "e53c7562-9ef3-4c87-86ea-bfd233cc6430",
                "port": "in",
                "size": 7
              },
              "size": 7
            ...
            {
              "source": {
                "block": "f472595e-1cf4-4657-bcff-0c1e65747068",
                "port": "out",
                "size": 7
              },
              "target": {
                "block": "04e6d6d4-1b61-4df6-a522-fe1b6daefabc",
                "port": "inlabel"
              },
              "size": 7
            },
