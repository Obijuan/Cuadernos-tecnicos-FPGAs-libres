{
    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# Transmisión de 5-bit \n\nSe envía el byte 0xe0 al apreta el pulsador SW1",
            "readonly": true
          },
          "position": {
            "x": 24,
        ...
        {
          "id": "4cc52dd0-c2a9-447b-9cc2-19f414ca8a58",
          "type": "2c91b11f415418680af31218631ba0772efb399e",
          "position": {
            "x": 240,
            "y": 360
          },
        ...
        {
          "id": "58e02b59-18a5-4518-9e83-628c7e99caca",
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "58e02b59-18a5-4518-9e83-628c7e99caca",
        ...
        },
        {
          ...
          "target": {
            "block": "4cc52dd0-c2a9-447b-9cc2-19f414ca8a58",
        ...
        },
        {
          ...
          "target": {
            "block": "4cc52dd0-c2a9-447b-9cc2-19f414ca8a58",
            "port": "c1490ccd-fa1d-493c-8498-c916c358a30b"
          },
          "vertices": [
            {
              "x": 184,
  ...
  "dependencies": {
    ...
    "2c91b11f415418680af31218631ba0772efb399e": {
      "package": {
        "name": "Sys-SR5-ld-verilog",
        "version": "0.3",
        "description": "Sys-SR5-ld-verilog: 5-bits System Shift register to the right, with load. Verilog implementation",
        "author": "Juan González-Gómez (Obijuan)",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "3ce266d8-1696-4439-8b6a-48c261dd9cb5",
              "type": "basic.output",
              "data": {
                "name": "",
                "range": "[4:0]",
            ...
            {
              "id": "78adbb3a-2b68-487f-b4ac-dd3d5a1991bd",
              "type": "basic.outputLabel",
              "data": {
                "name": "q",
                "range": "[4:0]",
            ...
            {
              "id": "c2eccccd-7f99-4cc5-b37d-f9b979465fea",
              "type": "basic.inputLabel",
              "data": {
                "name": "q",
                "range": "[4:0]",
            ...
            {
              "id": "238a3f27-3379-49a3-b957-bbb0cd6b73b2",
              "type": "basic.outputLabel",
              "data": {
                "name": "d",
                "range": "[4:0]",
            ...
            {
              "id": "f271ffe5-c891-4200-9f87-ecfa2d3822b1",
              "type": "basic.inputLabel",
              "data": {
                "name": "d",
                "range": "[4:0]",
            ...
            {
              "id": "c1490ccd-fa1d-493c-8498-c916c358a30b",
              "type": "basic.input",
              "data": {
                "name": "d",
                "range": "[4:0]",
          ...
          "wires": [
            ...
            {
              "source": {
                "block": "78adbb3a-2b68-487f-b4ac-dd3d5a1991bd",
                "port": "outlabel"
              },
              "target": {
                "block": "3ce266d8-1696-4439-8b6a-48c261dd9cb5",
                "port": "in",
                "size": 5
              },
              "size": 5
            },
            {
              ...
              "target": {
                "block": "c2eccccd-7f99-4cc5-b37d-f9b979465fea",
                "port": "inlabel"
              },
              "size": 5
            },
            {
              "source": {
                "block": "238a3f27-3379-49a3-b957-bbb0cd6b73b2",
                "port": "outlabel"
              },
              "target": {
                "block": "065d71ce-8cdc-4298-a5fe-42613b6d5d0a",
            ...
            {
              "source": {
                "block": "c1490ccd-fa1d-493c-8498-c916c358a30b",
                "port": "out",
                "size": 5
              },
              "target": {
                "block": "f271ffe5-c891-4200-9f87-ecfa2d3822b1",
                "port": "inlabel"
              },
              "size": 5
            },
