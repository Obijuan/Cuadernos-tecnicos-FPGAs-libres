{
    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# Transmisión de 4-bits \n\nSe envía el byte 0xf0 al arrancar el circuito y al apretar el pulsador SW1",
            "readonly": true
          },
          "position": {
            "x": 216,
  ...
  "dependencies": {
    ...
    "85e811f29ab62304ba0727120b2b2401b77c0519": {
      "package": {
        "name": "Sys-SR-rst-04-verilog",
        "version": "0.4",
        "description": "Sys-SR-rst-04-verilog: 4-bits System Shift register to the right, with reset.  Verilog implementation",
        "author": "Juan González-Gómez (Obijuan)",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "a32f7dab-ca55-4e73-ad35-06ad08185ea8",
              "type": "basic.output",
              "data": {
                "name": "",
                "range": "[3:0]",
          ...
          "wires": [
            ...
            },
            {
              ...
              "target": {
                "block": "a32f7dab-ca55-4e73-ad35-06ad08185ea8",
                "port": "in"
              },
              "size": 4
            }
