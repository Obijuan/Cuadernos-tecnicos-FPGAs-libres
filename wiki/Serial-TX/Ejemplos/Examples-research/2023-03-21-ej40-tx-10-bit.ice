{
    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# Transmisión de 10-bit \n\nSe envía el byte 0x00 al apreta el pulsador SW1",
            "readonly": true
          },
          "position": {
            "x": -1208,
        ...
        {
          "id": "37be47be-4de2-4696-9abd-1c075bd6c4e7",
        ...
        {
          "id": "01602029-48b6-4fd9-9707-edce98746c3c",
          "type": "0f7160dec657af0cec3ef6f7090913a2ab263cec",
          "position": {
            "x": -664,
            "y": 336
        ...
        {
          "id": "4e46f5ac-fc16-48ec-98a5-123a30ad0642",
          "type": "basic.info",
          "data": {
            "info": "Sys-DFF-ld",
            "readonly": true
        ...
        {
          "id": "2d8bf48c-2fdd-454b-bb96-62d9bd8a6b16",
          "type": "2cbb3f0edae4bdc12fb33898efca25e8390efc24",
          "position": {
            "x": -992,
            "y": 336
          },
        ...
        {
          "id": "52fe3edb-8ac5-49ca-8ab9-452fe4537754",
      ...
      "wires": [
        {
          ...
          "target": {
            "block": "37be47be-4de2-4696-9abd-1c075bd6c4e7",
        ...
        },
        {
          ...
          "target": {
            "block": "01602029-48b6-4fd9-9707-edce98746c3c",
            "port": "65194b18-5d2a-41b2-bd86-01be99978ad6"
          }
        },
        {
          ...
          "target": {
            "block": "52fe3edb-8ac5-49ca-8ab9-452fe4537754",
        ...
        },
        {
          ...
          "target": {
            "block": "2d8bf48c-2fdd-454b-bb96-62d9bd8a6b16",
        ...
        },
        {
          ...
          "target": {
            "block": "2d8bf48c-2fdd-454b-bb96-62d9bd8a6b16",
            "port": "1f73699a-545e-412f-a41b-4663e76704f3"
          },
          "vertices": [
            {
              "x": -1048,
  ...
  "dependencies": {
    ...
    "2cbb3f0edae4bdc12fb33898efca25e8390efc24": {
      "package": {
        "name": "Sys-SR10-ld-verilog",
        "version": "0.3",
        "description": "Sys-SR10-ld-verilog: 10-bits System Shift register to the right, with load. Verilog implementation",
        "author": "Juan González-Gómez (Obijuan)",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "6d37de31-e62d-4e3e-84dd-44b7ad077ba9",
              "type": "basic.outputLabel",
              "data": {
                "name": "q",
                "range": "[9:0]",
            ...
            {
              "id": "0b868595-ff88-4cd4-99d8-d6d93308446a",
              "type": "basic.output",
              "data": {
                "name": "",
                "range": "[9:0]",
            ...
            {
              "id": "a48c3e2c-1161-4adb-8fe7-3076d8f5fed4",
              "type": "basic.inputLabel",
              "data": {
                "name": "q",
                "range": "[9:0]",
            ...
            {
              "id": "2d5a9851-d82f-4aa4-9a8b-0f6a16195a52",
              "type": "basic.outputLabel",
              "data": {
                "name": "d",
                "range": "[9:0]",
            ...
            {
              "id": "f7b50d8d-2750-475c-8909-44331a90ff25",
              "type": "basic.inputLabel",
              "data": {
                "name": "d",
                "range": "[9:0]",
            ...
            {
              "id": "1f73699a-545e-412f-a41b-4663e76704f3",
              "type": "basic.input",
              "data": {
                "name": "d",
                "range": "[9:0]",
          ...
          "wires": [
            ...
            },
            {
              ...
              "target": {
                "block": "a48c3e2c-1161-4adb-8fe7-3076d8f5fed4",
                "port": "inlabel"
              },
              "size": 10
            },
            {
              "source": {
                "block": "2d5a9851-d82f-4aa4-9a8b-0f6a16195a52",
                "port": "outlabel"
              },
              "target": {
                "block": "065d71ce-8cdc-4298-a5fe-42613b6d5d0a",
            ...
            {
              "source": {
                "block": "1f73699a-545e-412f-a41b-4663e76704f3",
                "port": "out",
                "size": 10
              },
              "target": {
                "block": "f7b50d8d-2750-475c-8909-44331a90ff25",
                "port": "inlabel"
              },
              "size": 10
            },
            {
              "source": {
                "block": "6d37de31-e62d-4e3e-84dd-44b7ad077ba9",
                "port": "outlabel"
              },
              "target": {
                "block": "0b868595-ff88-4cd4-99d8-d6d93308446a",
                "port": "in",
                "size": 10
              },
              "size": 10
