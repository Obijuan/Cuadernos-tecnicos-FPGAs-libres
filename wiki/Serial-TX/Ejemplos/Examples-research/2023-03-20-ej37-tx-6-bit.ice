{
    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# Transmisión de 6-bit \n\nSe envía el byte 0xc0 al apreta el pulsador SW1",
            "readonly": true
          },
          "position": {
            "x": -272,
        ...
        {
          "id": "adf21c3b-3c7b-4453-a967-87be1da6b976",
          "type": "04cc6bfe743e59496510326f26139a27799849ac",
          "position": {
            "x": -32,
            "y": 336
          },
        ...
        {
          "id": "3d6928d1-7ff1-4ab5-abaf-37a1977e6087",
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "3d6928d1-7ff1-4ab5-abaf-37a1977e6087",
        ...
        },
        {
          ...
          "target": {
            "block": "adf21c3b-3c7b-4453-a967-87be1da6b976",
        ...
        },
        {
          ...
          "target": {
            "block": "adf21c3b-3c7b-4453-a967-87be1da6b976",
            "port": "51e5e81c-fd5b-465f-80fd-e4cb2acce5a7"
          },
          "vertices": [
            {
              "x": -88,
  ...
  "dependencies": {
    ...
    "04cc6bfe743e59496510326f26139a27799849ac": {
      "package": {
        "name": "Sys-SR6-ld-verilog",
        "version": "0.3",
        "description": "Sys-SR6-ld-verilog: 6-bits System Shift register to the right, with load. Verilog implementation",
        "author": "Juan González-Gómez (Obijuan)",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "663b80c4-cb57-4d1f-930e-c090ffdf527b",
              "type": "basic.output",
              "data": {
                "name": "",
                "range": "[5:0]",
            ...
            {
              "id": "bcc27b1f-8e30-46f6-b214-8daef38980eb",
              "type": "basic.outputLabel",
              "data": {
                "name": "q",
                "range": "[5:0]",
            ...
            {
              "id": "4fee3ce0-4ff6-44b7-bb36-eb7727eccb74",
              "type": "basic.inputLabel",
              "data": {
                "name": "q",
                "range": "[5:0]",
            ...
            {
              "id": "99282226-8523-495d-8e49-15609a90b1d1",
              "type": "basic.outputLabel",
              "data": {
                "name": "d",
                "range": "[5:0]",
            ...
            {
              "id": "b1d7db67-4489-485f-9392-d38b14a6f117",
              "type": "basic.inputLabel",
              "data": {
                "name": "d",
                "range": "[5:0]",
            ...
            {
              "id": "51e5e81c-fd5b-465f-80fd-e4cb2acce5a7",
              "type": "basic.input",
              "data": {
                "name": "d",
                "range": "[5:0]",
          ...
          "wires": [
            ...
            },
            {
              ...
              "target": {
                "block": "4fee3ce0-4ff6-44b7-bb36-eb7727eccb74",
                "port": "inlabel"
              },
              "size": 6
            },
            {
              "source": {
                "block": "99282226-8523-495d-8e49-15609a90b1d1",
                "port": "outlabel"
              },
              "target": {
                "block": "065d71ce-8cdc-4298-a5fe-42613b6d5d0a",
            ...
            {
              "source": {
                "block": "bcc27b1f-8e30-46f6-b214-8daef38980eb",
                "port": "outlabel"
              },
              "target": {
                "block": "663b80c4-cb57-4d1f-930e-c090ffdf527b",
                "port": "in",
                "size": 6
              },
              "size": 6
            ...
            {
              "source": {
                "block": "51e5e81c-fd5b-465f-80fd-e4cb2acce5a7",
                "port": "out",
                "size": 6
              },
              "target": {
                "block": "b1d7db67-4489-485f-9392-d38b14a6f117",
                "port": "inlabel"
              },
              "size": 6
            },
