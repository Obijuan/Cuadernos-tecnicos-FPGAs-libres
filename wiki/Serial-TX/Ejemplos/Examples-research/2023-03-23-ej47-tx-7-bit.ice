{
    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# Transmisión de 7-bit \n\nSe envía el byte 0x80 al apreta el pulsador SW1 y 0xff al apretar reset",
            "readonly": true
          },
          "position": {
            "x": -240,
        ...
        {
          "id": "bbaf47d6-dc12-4bc4-9f51-96efbe60538d",
          "type": "11a28b9b7abcd71173cddbe204c5177de4995232",
          "position": {
            "x": 40,
            "y": 344
          },
        ...
        {
          "id": "3e58f5d2-438e-4ba8-b38b-3241696596c8",
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "bbaf47d6-dc12-4bc4-9f51-96efbe60538d",
        ...
        },
        {
          ...
          "target": {
            "block": "3e58f5d2-438e-4ba8-b38b-3241696596c8",
        ...
        },
        {
          ...
          "target": {
            "block": "bbaf47d6-dc12-4bc4-9f51-96efbe60538d",
            "port": "0b814e92-c1df-4d18-b7b8-7ba61e89e05f"
          },
          "vertices": [
            {
              "x": -16,
  ...
  "dependencies": {
    ...
    "11a28b9b7abcd71173cddbe204c5177de4995232": {
      "package": {
        "name": "Sys-SR7-ld-rst-verilog",
        "version": "0.4",
        "description": "Sys-SR7-ld-rst-verilog: 7-bits System Shift register to the right, with load. Verilog implementation",
        "author": "Juan González-Gómez (Obijuan)",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "0988791d-2f11-4fbb-974b-e3a4c2ad9ebd",
              "type": "basic.inputLabel",
              "data": {
                "name": "q",
                "range": "[6:0]",
            ...
            {
              "id": "dc101178-6092-470e-a466-dbad5d654d45",
              "type": "basic.output",
              "data": {
                "name": "",
                "range": "[6:0]",
            ...
            {
              "id": "68637ced-55bc-4868-9cb7-493153ae4d7b",
              "type": "basic.outputLabel",
              "data": {
                "name": "q",
                "range": "[6:0]",
            ...
            {
              "id": "51f5a73b-a31a-483e-8c94-3f33ff0a76b3",
              "type": "basic.outputLabel",
              "data": {
                "name": "d",
                "range": "[6:0]",
            ...
            {
              "id": "26e5862f-18e8-4363-9e20-8b64d7b90ea1",
              "type": "basic.inputLabel",
              "data": {
                "name": "d",
                "range": "[6:0]",
            ...
            {
              "id": "0b814e92-c1df-4d18-b7b8-7ba61e89e05f",
              "type": "basic.input",
              "data": {
                "name": "d",
                "range": "[6:0]",
          ...
          "wires": [
            ...
            },
            {
              ...
              "target": {
                "block": "0988791d-2f11-4fbb-974b-e3a4c2ad9ebd",
                "port": "inlabel"
              },
              "size": 7
            },
            {
              "source": {
                "block": "51f5a73b-a31a-483e-8c94-3f33ff0a76b3",
                "port": "outlabel"
              },
              "target": {
                "block": "065d71ce-8cdc-4298-a5fe-42613b6d5d0a",
            ...
            {
              "source": {
                "block": "0b814e92-c1df-4d18-b7b8-7ba61e89e05f",
                "port": "out",
                "size": 7
              },
              "target": {
                "block": "26e5862f-18e8-4363-9e20-8b64d7b90ea1",
                "port": "inlabel"
              },
              "size": 7
            },
            {
              "source": {
                "block": "68637ced-55bc-4868-9cb7-493153ae4d7b",
                "port": "outlabel"
              },
              "target": {
                "block": "dc101178-6092-470e-a466-dbad5d654d45",
                "port": "in",
                "size": 7
              },
              "size": 7
