{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "3ea79f2c-64a0-43b7-a7bb-bb808acb79f0",
          "type": "7271dd4fc35f4ce59fd076a5b15c5fc9bca60ad6",
          "position": {
            "x": -992,
            "y": 336
          },
        ...
        {
          "id": "3f9d41da-ee42-4bdd-9041-f29b7b5f2aef",
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "3f9d41da-ee42-4bdd-9041-f29b7b5f2aef",
        ...
        },
        {
          ...
          "target": {
            "block": "3ea79f2c-64a0-43b7-a7bb-bb808acb79f0",
        ...
        },
        {
          ...
          "target": {
            "block": "3ea79f2c-64a0-43b7-a7bb-bb808acb79f0",
            "port": "1dc5055e-54d3-4cdb-9f6d-20fac35cbdef"
          },
          "vertices": [
            {
              "x": -1040,
  ...
  "dependencies": {
    ...
    "7271dd4fc35f4ce59fd076a5b15c5fc9bca60ad6": {
      "package": {
        "name": "Sys-SR9-ld-verilog",
        "version": "0.3",
        "description": "Sys-SR9-ld-verilog: 9-bits System Shift register to the right, with load. Verilog implementation",
        "author": "Juan González-Gómez (Obijuan)",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "72307b53-8e9a-4f99-9f67-3b67e42032e1",
              "type": "basic.outputLabel",
              "data": {
                "name": "q",
                "range": "[8:0]",
            ...
            {
              "id": "94f8789a-f500-44ed-9c5a-3fcdd62f3612",
              "type": "basic.output",
              "data": {
                "name": "",
                "range": "[8:0]",
            ...
            {
              "id": "a32b3e6b-306d-467b-b449-0da2bcb6fabe",
              "type": "basic.inputLabel",
              "data": {
                "name": "q",
                "range": "[8:0]",
            ...
            {
              "id": "664c31f0-fa03-4d99-9592-02c736c55831",
              "type": "basic.outputLabel",
              "data": {
                "name": "d",
                "range": "[8:0]",
            ...
            {
              "id": "00ca5192-cdfb-4034-9be6-6629985450db",
              "type": "basic.inputLabel",
              "data": {
                "name": "d",
                "range": "[8:0]",
            ...
            {
              "id": "1dc5055e-54d3-4cdb-9f6d-20fac35cbdef",
              "type": "basic.input",
              "data": {
                "name": "d",
                "range": "[8:0]",
          ...
          "wires": [
            ...
            {
              "source": {
                "block": "664c31f0-fa03-4d99-9592-02c736c55831",
                "port": "outlabel"
              },
              "target": {
                "block": "065d71ce-8cdc-4298-a5fe-42613b6d5d0a",
            ...
            {
              "source": {
                "block": "72307b53-8e9a-4f99-9f67-3b67e42032e1",
                "port": "outlabel"
              },
              "target": {
