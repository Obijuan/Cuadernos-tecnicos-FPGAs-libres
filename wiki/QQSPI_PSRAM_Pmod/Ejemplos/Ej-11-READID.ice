    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# Ejemplo 11: Comando READID\n\nPrueba del comando READID... Lectura completa del identificador (6 bytes)\nSegún la hoja de datos, Los dos primeros bytes deben ser: `0x0D` y `0x5D`\n",
            "readonly": true
          },
          "position": {
            "x": -1000,
        ...
        {
          "id": "f060a1f7-add3-43c7-a754-d78c7b45c359",
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "f060a1f7-add3-43c7-a754-d78c7b45c359",
