    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# Ejemplo 9: Comando READID\n\nPrimera prueba del comando READID... Se envían 4 bytes del comando READID: 9F dummy dummy dummy  \nSe envía un byte más para la lectura de la respuesta  \nSegún la hoja de datos, este primer byte leido debe ser: `0x0D\n",
            "readonly": true
          },
          "position": {
            "x": -1016,
