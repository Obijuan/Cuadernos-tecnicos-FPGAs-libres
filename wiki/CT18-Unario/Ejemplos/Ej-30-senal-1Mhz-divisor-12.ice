    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# Ejemplo 30: Señal de 1 Mhz\n\nUtilizamos un contador unario optimizado de 11 marcas, para implementar el divisor entre 12 y generar así una señal de 1Mhz  \nComprobaremos que la señal es correcta midiéndola con el Analizador interno **iceRok**",
            "readonly": true
          },
          "position": {
            "x": 712,
