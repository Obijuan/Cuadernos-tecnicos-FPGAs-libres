    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# Ejemplo 31: Señal de 100Khz\n\nUtilizamos dos divisores encadenados para dividir la señal de reloj entre 12 y luego entre 10 (División total de 120), lo que  \nnos genera una señal final de 100Khz. Con la primera división obtenemos una señal de 1Mhz. Y con la segunda 1Mhz/10 = 100Khz\n\nPara el segundo divisor usamos un contador unario optimizado de 9 marcas.\nComprobaremos que la señal es correcta midiéndola con el Analizador interno **iceRok**\n",
            "readonly": true
          },
          "position": {
            "x": 608,
