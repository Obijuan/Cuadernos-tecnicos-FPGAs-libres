  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "ca38ac59-06d8-4b40-b607-b55c49cc2432",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "virtual": false,
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# Ejemplo 15: Disparar acción al apretar el pulsador 2 veces\n\nEl controlador lleva la cuenta de las pulsaciones del botón `SW1`. Cuando se pulsa la segunda vez, se  \nactiva la acción (coche fantástico en los LEDs). El número de pulsaciones se muestra en unario en  \nlos LEDs verdes (con alineación a la derecha)\n",
            "readonly": true
          },
          "position": {
            "x": 456,
        ...
        {
          "id": "509e955e-916e-44b8-b51f-71305ede4833",
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "509e955e-916e-44b8-b51f-71305ede4833",
        ...
        },
        {
          ...
          "target": {
            "block": "ca38ac59-06d8-4b40-b607-b55c49cc2432",
            "port": "in"
          },
          "size": 2
        },
