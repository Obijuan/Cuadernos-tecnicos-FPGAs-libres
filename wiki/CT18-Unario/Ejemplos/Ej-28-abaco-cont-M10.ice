  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "ce219220-b877-436a-8d82-314023b1b87c",
          "type": "basic.input",
          "data": {
            "name": "Boton",
            "virtual": false,
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# Ejemplo 28: Contador manual módulo 10\n\nCon cada pulsación del botón `SW1` se incrementan las unidades, que se muestran en los LEDs D8 - D0  (Con alineación  \na la izquierda).  Cuando las unidades llegan a 9 y se aprieta el botón, el contador vuelve a 0  \n\n",
            "readonly": true
          },
          "position": {
            "x": 824,
        ...
        {
          "id": "5a414d2b-ad78-44a3-979d-f21569eccf01",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "## Evento manual: contar unidades",
            "readonly": true
          },
          "position": {
            "x": 848,
        ...
        {
          "id": "1ad00e29-091e-4efb-b4a0-45f4dd1c0832",
          "type": "basic.info",
          "data": {
            "info": "Valor máximo  \nalcanzado",
            "readonly": true
      ...
      "wires": [
        {
          "source": {
            "block": "ce219220-b877-436a-8d82-314023b1b87c",
            "port": "out"
          },
          "target": {
            "block": "5a414d2b-ad78-44a3-979d-f21569eccf01",
