  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "c4f64b2a-87e9-44ca-a3c6-4b176b7c6e23",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "virtual": false,
        ...
        {
          "id": "82078caa-2172-4e50-801f-ea82db5b5d78",
          "type": "basic.input",
          "data": {
            "name": "Boton",
            "virtual": false,
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# Ejemplo 19: Contador de 2 marcas con reset automático\n\nContador manual unario de 2 marcas. Al apretar el pulsador `SW1` se incrementa el contador unario  \nEl contador tiene sólo 1 marca. El contador empieza en 0, y cuenta hasta `11`  \nCuando está en su valor máximo, si se vuelve a apreta `SW2` el contador vuelve a su estado inicial.  \nEl resultado es que este contador nunca para: al llegar al máximo vuelve a comenzar",
            "readonly": true
          },
          "position": {
            "x": 584,
        ...
        {
          "id": "88081623-204e-4b74-8cbf-1361ffab7f6e",
        ...
        {
          "id": "e033639c-13d5-46d1-b664-430a9d7e1ed8",
      ...
      "wires": [
        {
          "source": {
            "block": "82078caa-2172-4e50-801f-ea82db5b5d78",
            "port": "out"
          },
          "target": {
            "block": "88081623-204e-4b74-8cbf-1361ffab7f6e",
        ...
        },
        {
          ...
          "target": {
            "block": "e033639c-13d5-46d1-b664-430a9d7e1ed8",
        ...
        },
        {
          ...
          "target": {
            "block": "c4f64b2a-87e9-44ca-a3c6-4b176b7c6e23",
            "port": "in"
          },
          "size": 2
        },
