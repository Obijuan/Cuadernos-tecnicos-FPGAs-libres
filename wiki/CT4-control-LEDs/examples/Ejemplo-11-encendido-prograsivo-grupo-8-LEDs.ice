  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "c168e9ee-2be8-4749-a48f-009c7268179c",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "### Ejemplo 11: Encendido progresivo\n\nAl arrancar el circuito (después del reset) el grupo de 8 LEDs se  \nenciende progresivamente desde 0 (apagados) hasta 255 (Máxima intesidad)  \nSe emplea un tiempo de 1 segundo",
            "readonly": true
          },
          "position": {
            "x": -128,
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "c168e9ee-2be8-4749-a48f-009c7268179c",
