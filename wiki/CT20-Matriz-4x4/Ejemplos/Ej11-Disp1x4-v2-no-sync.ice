    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# Ejemplo 11: Display 1x4-v2. Rásters NO sincronizados\n\nEn la memoria se almacena el patrón `1101`, pero debido a que los rásters NO  \nestán sincronizados lo que se visualiza es 🔴🔴🔴⚫  ",
            "readonly": true
          },
          "position": {
            "x": -1800,
