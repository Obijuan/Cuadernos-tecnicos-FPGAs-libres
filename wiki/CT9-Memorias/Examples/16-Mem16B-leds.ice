{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "548fe907-9396-4d60-8bdd-6d9e8bb8ecdc",
          "type": "basic.outputLabel",
          "data": {
            "blockColor": "fuchsia",
            "name": "LB1",
        ...
        {
          "id": "83bbe8ac-d722-4601-b15e-5a52501c5234",
          "type": "basic.outputLabel",
          "data": {
            "blockColor": "fuchsia",
            "name": "LB2",
        ...
        {
          "id": "834404a4-aaa0-4290-9371-471efe0d4299",
          "type": "basic.inputLabel",
          "data": {
            "name": "addr",
            "range": "[3:0]",
        ...
        {
          "id": "de25884f-645f-45c5-921a-e1348cde43f2",
          "type": "basic.outputLabel",
          "data": {
            "blockColor": "fuchsia",
            "name": "B2",
        ...
        {
          "id": "d166d6b9-37b1-4548-9373-fd7fc8a7bc61",
          "type": "basic.outputLabel",
          "data": {
            "name": "addr",
            "range": "[3:0]",
        ...
        {
          "id": "73fa46af-d882-4fdf-8af8-76a284bcea22",
          "type": "basic.outputLabel",
          "data": {
            "blockColor": "fuchsia",
            "name": "B1",
        ...
        {
          "id": "2d368b7a-c8a5-46b1-a3cc-a320a4f087f3",
          "type": "basic.memory",
          "data": {
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "Pulsación normal: dirección  \nanterior",
            "readonly": true
          },
          "position": {
            "x": -288,
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "Pulsación larga: Incrementar en 1  \nel dato de la posición actual",
            "readonly": true
          },
          "position": {
            "x": -288,
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "Con las pulsaciones largas  \nse emite un tic de write  \npara escribir el nuevo dato",
            "readonly": true
          },
          "position": {
            "x": 528,
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "Mostrar la salida de la \nmemoria por los LEDs",
            "readonly": true
          },
          "position": {
            "x": 1064,
        ...
        {
          "id": "433ef245-dd0b-4b2d-8f38-5eff99cb4130",
        ...
        {
          "id": "914cffe3-a0bd-46fa-aeed-864f3e2a8c54",
          "type": "basic.info",
          "data": {
        ...
        {
          "id": "1c758131-f95e-4e7f-9430-a2401060a360",
          "type": "basic.info",
          "data": {
            "info": "Pulsación larga: Incrementar  \nen 64 el dato de la posición  \nactual",
            "readonly": true
          },
          "position": {
            "x": -304,
        ...
        {
          "id": "db0fa2e5-b5f3-4393-bcd6-1321fc80d9c6",
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "433ef245-dd0b-4b2d-8f38-5eff99cb4130",
        ...
        {
          "source": {
            "block": "2d368b7a-c8a5-46b1-a3cc-a320a4f087f3",
            "port": "memory-out"
          },
          "target": {
            "block": "433ef245-dd0b-4b2d-8f38-5eff99cb4130",
        ...
        {
          "source": {
            "block": "fe3773d6-220c-4a07-9c14-0e4e6a96fd50",
            "port": "6956e956-e2f3-4a24-86cd-181915d34b05"
          },
          "target": {
            "block": "834404a4-aaa0-4290-9371-471efe0d4299",
            "port": "inlabel"
          },
          "size": 4
        },
        {
          "source": {
            "block": "d166d6b9-37b1-4548-9373-fd7fc8a7bc61",
            "port": "outlabel"
          },
          "target": {
            "block": "433ef245-dd0b-4b2d-8f38-5eff99cb4130",
        ...
        },
        {
          ...
          "target": {
            "block": "b36f5f3f-2c9c-4a98-9899-8e4148af4a02",
            "port": "inlabel"
          }
        },
        {
          "source": {
            "block": "73fa46af-d882-4fdf-8af8-76a284bcea22",
            "port": "outlabel"
          },
          "target": {
            "block": "fe3773d6-220c-4a07-9c14-0e4e6a96fd50",
        ...
        {
          "source": {
            "block": "fb453875-7d17-4b67-abbc-567a2c55ed95",
            "port": "e88dcc91-146f-4717-a3e1-0756bb8b3c60"
          },
          "target": {
            "block": "c149371f-ad5f-4c7c-a9ad-efb0ac7b22f6",
            "port": "inlabel"
          },
          "vertices": []
        },
        ...
        {
          "source": {
            "block": "de25884f-645f-45c5-921a-e1348cde43f2",
            "port": "outlabel"
          },
          "target": {
            "block": "fe3773d6-220c-4a07-9c14-0e4e6a96fd50",
        ...
        },
        {
          ...
          "target": {
            "block": "aa245b5b-0142-41e6-843d-ab9c4bb00f02",
            "port": "inlabel"
          }
        },
        {
          ...
          "target": {
            "block": "12144506-1cb6-44b2-bdf6-5c300c3ce19e",
            "port": "inlabel"
          }
        },
        {
          "source": {
            "block": "548fe907-9396-4d60-8bdd-6d9e8bb8ecdc",
            "port": "outlabel"
          },
          "target": {
            "block": "37dbc066-2426-4abf-9202-7a7886ff0c2c",
        ...
        {
          "source": {
            "block": "83bbe8ac-d722-4601-b15e-5a52501c5234",
            "port": "outlabel"
          },
          "target": {
            "block": "37dbc066-2426-4abf-9202-7a7886ff0c2c",
        ...
        },
        {
          ...
          "target": {
            "block": "db0fa2e5-b5f3-4393-bcd6-1321fc80d9c6",
  ...
  "dependencies": {
    ...
    "e4b02246e3e3b773ce2e09165a35ebea9e22ff67": {
      "package": {
