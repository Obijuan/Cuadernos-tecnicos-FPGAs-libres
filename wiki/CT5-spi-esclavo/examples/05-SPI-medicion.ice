{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "3be97ff6-ace3-4be0-9009-a820270ab59b",
        ...
        {
          "id": "f657d154-6eda-40a1-aafd-ebd86008e5d9",
          "type": "basic.outputLabel",
          "data": {
        ...
        {
          "id": "3d19f373-5d5c-4484-831e-e53fecf964ec",
          "type": "basic.outputLabel",
          "data": {
            "blockColor": "coral",
            "name": "MOSI",
        ...
        {
          "id": "3407368f-f2ae-4159-baa5-59983bb75150",
          "type": "basic.outputLabel",
          "data": {
        ...
        {
          "id": "d8c87179-2fbd-4eba-b603-37db14b02934",
        ...
        {
          "id": "d017c436-8eb6-4062-981a-1d75b168acca",
          "type": "basic.inputLabel",
          "data": {
            "blockColor": "indianred",
            "name": "SCLK",
        ...
        {
          "id": "0fefc9b1-575a-4dda-91ac-14be2480e3e5",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "range": "[7:0]",
        ...
        {
          "id": "6c617d31-289f-4b34-9282-cdd6955d4a88",
          "type": "basic.inputLabel",
          "data": {
            "blockColor": "darkgreen",
            "name": "MISO",
        ...
        {
          "id": "52eb0658-c9e0-4c9c-bc2c-562d0befbb8a",
          "type": "basic.inputLabel",
          "data": {
            "blockColor": "fuchsia",
            "name": "SS",
        ...
        {
          "id": "70edccbc-21ab-49e9-8c95-5709db76aab2",
          "type": "basic.constant",
          "data": {
            "name": "",
            "value": "1",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "### Ejemplo 5: Midiendo el SPI\n\nSacamos las señales del SPI del ejemplo 4 se han  \netiquetado para indicar los canales a los que están  \nconectadas\n",
            "readonly": true
          },
          "position": {
            "x": 328,
        ...
        {
          "id": "7afa106a-fb0f-42e4-8adc-0130bfec2a63",
        ...
        {
          "id": "d30d323c-8c23-469f-b2a2-d6ccd2ac3e48",
          "type": "basic.info",
          "data": {
            "info": "Dato recibido",
            "readonly": true
        ...
        {
          "id": "bfeecf5b-e0a2-42ba-a01b-6daa484f3475",
          "type": "basic.info",
          "data": {
            "info": "Dato recibido  \nincrementado",
            "readonly": true
        ...
        {
          "id": "d64dc77a-f3a4-4ff4-8fa4-9cf038946b89",
          "type": "basic.info",
          "data": {
            "info": "El dato incrementado  \nse carga cuando ha  \nterminar la transacción  \nactual",
            "readonly": true
          },
          "position": {
            "x": 504,
        ...
        {
          "id": "efc87bc6-66e5-4f8a-b21c-5aa10f160e7a",
          "type": "basic.info",
          "data": {
            "info": "## CONEXIÓN CON ANALIZADOR LÓGICO",
            "readonly": true
          },
          "position": {
            "x": 768,
        ...
        {
          "id": "36415376-0a83-461f-b8c3-ece85f81e051",
          "type": "c63f32d68a8b7a90858954b6757f1bc8b98494ba",
          "position": {
            "x": 680,
            "y": 280
          },
        ...
        {
          "id": "aa5eed4b-2242-46e2-a0b8-4e18dae1391a",
          "type": "basic.info",
          "data": {
            "info": "**CANAL 0**",
            "readonly": true
        ...
        {
          "id": "02f3157e-5a57-4f66-84c7-bd356e6a32ec",
          "type": "basic.info",
          "data": {
            "info": "**CANAL 1**",
            "readonly": true
        ...
        {
          "id": "235251f9-8e23-49f6-b58b-16f85d272cfb",
          "type": "basic.info",
          "data": {
            "info": "**CANAL 2**",
            "readonly": true
        ...
        {
          "id": "2a5c44ba-8456-4a47-a595-47f1210cf382",
          "type": "basic.info",
          "data": {
            "info": "**CANAL 3**",
            "readonly": true
      ...
      "wires": [
        {
          ...
          "target": {
            "block": "36415376-0a83-461f-b8c3-ece85f81e051",
        ...
        },
        {
          ...
          "target": {
            "block": "0fefc9b1-575a-4dda-91ac-14be2480e3e5",
            "port": "in"
          },
          "size": 8
        },
        ...
        {
          "source": {
            "block": "70edccbc-21ab-49e9-8c95-5709db76aab2",
            "port": "constant-out"
          },
          "target": {
            "block": "7afa106a-fb0f-42e4-8adc-0130bfec2a63",
        ...
        },
        {
          ...
          "target": {
            "block": "d8c87179-2fbd-4eba-b603-37db14b02934",
            "port": "inlabel"
          }
        },
        {
          ...
          "target": {
            "block": "d017c436-8eb6-4062-981a-1d75b168acca",
            "port": "inlabel"
          }
        },
        {
          ...
          "target": {
            "block": "52eb0658-c9e0-4c9c-bc2c-562d0befbb8a",
            "port": "inlabel"
          }
        },
        {
          ...
          "target": {
            "block": "6c617d31-289f-4b34-9282-cdd6955d4a88",
            "port": "inlabel"
          }
        },
        {
  ...
  "dependencies": {
    ...
    "c63f32d68a8b7a90858954b6757f1bc8b98494ba": {
      "package": {
        "name": "spi-slave-unit",
        "version": "0.1",
