{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "17c41d1c-d62b-462a-ba81-6e9533561a1d",
          "type": "basic.output",
          "data": {
            "name": "FILA3",
            "pins": [
        ...
        {
          "id": "0d3db9ee-4a0b-4cc3-9f7d-6e0e69be3240",
          "type": "basic.output",
          "data": {
            "name": "FILA2",
            "pins": [
        ...
        {
          "id": "3af5e63e-2cbf-4bfb-96fb-bfe5a2cbf194",
          "type": "basic.output",
          "data": {
            "name": "FILA1",
            "pins": [
        ...
        {
          "id": "c3b2e676-d3ca-4b22-b610-fa088f99a649",
          "type": "basic.output",
          "data": {
            "name": "FILA0",
            "pins": [
        ...
        {
          "id": "2676dfa1-42fa-4435-96f4-7bb80adccc7f",
          "type": "basic.output",
          "data": {
            "name": "COL3",
            "pins": [
        ...
        {
          "id": "c1219853-b2a6-484e-bfac-7e6e2912a842",
          "type": "basic.output",
          "data": {
            "name": "COL2",
            "pins": [
        ...
        {
          "id": "424d8da1-8e45-41b7-a929-00c2746b9160",
          "type": "basic.output",
          "data": {
            "name": "COL1",
            "pins": [
        ...
        {
          "id": "85cee605-79cc-4d43-844a-1ad3014111eb",
          "type": "basic.output",
          "data": {
            "name": "COL0",
            "pins": [
        ...
        {
          "id": "de9dbf56-645e-4029-92dc-684f21e97c1e",
        ...
        {
          "id": "d12497ce-0620-457c-91e0-66795f7ca565",
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "d12497ce-0620-457c-91e0-66795f7ca565",
            "port": "6d456c1e-ff83-4854-9fad-64401aabfe22"
          },
          "vertices": [
            {
              "x": -408,
        ...
        },
        {
          ...
          "target": {
            "block": "de9dbf56-645e-4029-92dc-684f21e97c1e",
        ...
        },
        {
          ...
          "target": {
            "block": "c3b2e676-d3ca-4b22-b610-fa088f99a649",
            "port": "in"
          },
          "vertices": [
            {
        ...
        },
        {
          ...
          "target": {
            "block": "3af5e63e-2cbf-4bfb-96fb-bfe5a2cbf194",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "0d3db9ee-4a0b-4cc3-9f7d-6e0e69be3240",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "17c41d1c-d62b-462a-ba81-6e9533561a1d",
            "port": "in"
          },
          "vertices": [
            {
        ...
        },
        {
          ...
          "target": {
            "block": "c1219853-b2a6-484e-bfac-7e6e2912a842",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "2676dfa1-42fa-4435-96f4-7bb80adccc7f",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "424d8da1-8e45-41b7-a929-00c2746b9160",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "85cee605-79cc-4d43-844a-1ad3014111eb",
            "port": "in"
          },
          "vertices": [
            {
