{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "ac302221-e666-44aa-9f6a-90a047c8f15c",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "virtual": false,
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "## Ejemplo 7: 14 LEDs encendidos todo el rato",
            "readonly": true
          },
          "position": {
            "x": 600,
        ...
        {
          "id": "6948ff97-11d1-4fef-890e-d0747c4ec379",
          "type": "0b554322444c573c9518875ce2dfc995fef565ac",
          "position": {
            "x": 792,
            "y": 488
          },
      ...
      "wires": [
        {
          ...
          "target": {
            "block": "6948ff97-11d1-4fef-890e-d0747c4ec379",
        ...
        },
        {
          "source": {
            "block": "6948ff97-11d1-4fef-890e-d0747c4ec379",
            "port": "0f8094f9-d01d-4c81-91ff-9940f4bf4b8b"
          },
          "target": {
            "block": "ac302221-e666-44aa-9f6a-90a047c8f15c",
            "port": "in"
          },
          "size": 14
        }
  ...
  "dependencies": {
    ...
    "0b554322444c573c9518875ce2dfc995fef565ac": {
      "package": {
        "name": "Copy-14-verilog",
        "version": "0.2",
        "description": "Copy-14: Copy the input wire twice and generate a 14 bits Bus output (Verilog implementation)",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "0f8094f9-d01d-4c81-91ff-9940f4bf4b8b",
              "type": "basic.output",
              "data": {
                "name": "",
                "range": "[13:0]",
          ...
          "wires": [
            ...
            },
            {
              ...
              "target": {
                "block": "0f8094f9-d01d-4c81-91ff-9940f4bf4b8b",
                "port": "in"
              },
              "size": 14
            }
