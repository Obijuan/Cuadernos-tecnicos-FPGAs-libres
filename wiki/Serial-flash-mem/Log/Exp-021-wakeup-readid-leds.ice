  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "870afd18-fecf-46f0-9a6c-e6cb89f6d089",
          "type": "basic.outputLabel",
          "data": {
            "name": "start",
            "blockColor": "red",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# Experimento 21: Mostrar identificador en los LEDs\n\ncada vez que se aprieta el pulsador se envían los comandos wakeup y readid, se leen los 4 bytes del identificador  \nSe muestran en los LEDs. Con el pulsador SW2 se visualizan los diferentes bytes (empezando por el de menor peso)",
            "readonly": true
          },
          "position": {
            "x": -3312,
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "870afd18-fecf-46f0-9a6c-e6cb89f6d089",
            "port": "outlabel"
          },
          "target": {
