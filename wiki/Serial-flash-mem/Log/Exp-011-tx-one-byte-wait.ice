  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "057cf601-e615-4f03-8689-58bc2ba824f4",
          "type": "basic.outputLabel",
          "data": {
            "name": "done2",
            "blockColor": "fuchsia",
        ...
        {
          "id": "1b69a62f-3d45-42bf-9251-6103af1dc61b",
          "type": "basic.outputLabel",
          "data": {
            "name": "done",
            "blockColor": "fuchsia",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# Experimento 10: Envío de un byte\n\nEnviar un byte por el spi al apretar el pulsador. Se usa una máquina de estados  \nCada vez que se aprieta el pulsador se hace un envío, siempre y cuando haya terminado el anterior",
            "readonly": true
          },
          "position": {
            "x": -3032,
        ...
        {
          "id": "342303f0-1a54-4808-9f48-1ed1b1e787be",
          "type": "873425949b2a80f1a7f66f320796bcd068a59889",
          "position": {
            "x": -1520,
            "y": 72
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "057cf601-e615-4f03-8689-58bc2ba824f4",
            "port": "outlabel"
          },
          "target": {
            "block": "342303f0-1a54-4808-9f48-1ed1b1e787be",
            "port": "18c2ebc7-5152-439c-9b3f-851c59bac834"
          }
        },
        {
          "source": {
            "block": "1b69a62f-3d45-42bf-9251-6103af1dc61b",
            "port": "outlabel"
          },
          "target": {
            "block": "342303f0-1a54-4808-9f48-1ed1b1e787be",
