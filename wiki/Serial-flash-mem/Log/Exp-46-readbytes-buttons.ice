    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# Experimento 46: Controlador Flash-readbyte-bus\n\nAplicación 1: Volcado consecutivo de los bytes situados en la posicion de memoria 0x04AABB en los LEDs. \nPrimero se visualiza automáticamente la primera posición. Al apretar SW1 se accede a la siguiente",
            "readonly": true
          },
          "position": {
            "x": -4112,
