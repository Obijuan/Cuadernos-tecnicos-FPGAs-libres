{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "12a10579-4e89-48d1-9801-fdd52843b5cd",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "virtual": false,
        ...
        {
          "id": "af461862-5148-478e-8a57-05a2797cf738",
          "type": "basic.constant",
          "data": {
            "name": "Tiempo_seg",
            "value": "1",
        ...
        {
          "id": "5b54c60f-d1a9-49f6-8854-c8652835b65d",
          "type": "basic.info",
          "data": {
            "info": "# Ejemplo 36: Segundero binario en los LEDs  \n\nCada vez que transcurre un segundo se incrementa el contador de segundos, que se muestra  \nen los LEDs",
            "readonly": true
          },
          "position": {
            "x": 416,
        ...
        {
          "id": "4fa454da-53db-4bdf-ac51-a996500c8e09",
        ...
        {
          "id": "9e24f3f1-8226-4314-81d1-ef59912a3126",
        ...
        {
          "id": "5faf229f-68aa-47ab-b38d-7376aa3fb0e3",
          "type": "19497dacf0673e047f87754fc5e378183f3c5da1",
          "position": {
            "x": 912,
            "y": 416
          },
      ...
      "wires": [
        {
          "source": {
            "block": "9e24f3f1-8226-4314-81d1-ef59912a3126",
            "port": "4e8afe74-8f38-4873-97ee-f7585d99a4aa"
          },
          "target": {
            "block": "5faf229f-68aa-47ab-b38d-7376aa3fb0e3",
            "port": "5726f071-b4ae-41b8-8b84-4f6b17c49e13"
          }
        },
        {
          "source": {
            "block": "4fa454da-53db-4bdf-ac51-a996500c8e09",
        ...
        {
          "source": {
            "block": "af461862-5148-478e-8a57-05a2797cf738",
            "port": "constant-out"
          },
          "target": {
            "block": "4fa454da-53db-4bdf-ac51-a996500c8e09",
        ...
        },
        {
          ...
          "target": {
            "block": "12a10579-4e89-48d1-9801-fdd52843b5cd",
            "port": "in"
          },
          "size": 8
        }
  ...
  "dependencies": {
    ...
    "19497dacf0673e047f87754fc5e378183f3c5da1": {
      "package": {
        "name": "Counter-x08",
        "version": "0.4",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "19d7b5cf-9261-4603-a55e-739b5d9b52df",
              "type": "basic.inputLabel",
              "data": {
                "name": "max",
                "blockColor": "fuchsia"
            ...
            {
              "id": "16483e90-7419-42ff-b8d6-112e0ce9051c",
              "type": "basic.outputLabel",
              "data": {
                "name": "max",
                "blockColor": "fuchsia"
            ...
            {
              "id": "1fa42fd9-f79d-4e81-8dff-e80ea8026b15",
              "type": "basic.output",
              "data": {
                "name": "max"
              },
          ...
          "wires": [
            ...
            },
            {
              ...
              "target": {
                "block": "19d7b5cf-9261-4603-a55e-739b5d9b52df",
                "port": "inlabel"
              }
            },
            {
              "source": {
                "block": "16483e90-7419-42ff-b8d6-112e0ce9051c",
                "port": "outlabel"
              },
              "target": {
                "block": "1fa42fd9-f79d-4e81-8dff-e80ea8026b15",
                "port": "in"
              }
            },
            {
