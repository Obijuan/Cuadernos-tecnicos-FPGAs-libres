    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# Ejemplo 20: Dos LEDs desfasados 90 grados (con pitidos)  \n\nDos LEDs se mueven con 90 grados de desfase y a la misma velocidad por un tramo de 4 posiciones  \nCuando alcanzan el último LED se emite un pitido",
            "readonly": true
          },
          "position": {
            "x": -368,
