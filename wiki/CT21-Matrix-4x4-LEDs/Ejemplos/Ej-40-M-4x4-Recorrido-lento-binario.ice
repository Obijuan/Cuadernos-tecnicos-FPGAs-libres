    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# Ejemplo 40: Matriz 4x4: Recorrer la matriz lentamente, en binario\n\nSe recorre lentamente la matrix 4x4 encendiendo todos los LEDs,  uno cada vez  \nLa fila y la columna están expresadas en BINARIO",
            "readonly": true
          },
          "position": {
            "x": -280,
        ...
        {
          "id": "243d589e-61f3-48e7-8a86-2b40fea749d9",
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "243d589e-61f3-48e7-8a86-2b40fea749d9",
