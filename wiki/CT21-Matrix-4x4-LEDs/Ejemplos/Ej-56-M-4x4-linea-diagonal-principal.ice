    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# Ejemplo 56: Matriz 4x4: Línea diagonal principal (`\\`)\n\nDibujo de una línea diagonal desde la esquina superior izquierda (0,0) hasta la esquina  \ninferior derecha (3,3)",
            "readonly": true
          },
          "position": {
            "x": -376,
