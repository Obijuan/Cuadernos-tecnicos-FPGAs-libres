    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# Ejemplo 6: Matriz 2x2: Ráster lento en fila 0\n\nEl Ráster X recorre las columnas 0 y 1, a baja frecuencia (2Hz)  \nEl Ráster Y es constante, señalando siempre la fila 0",
            "readonly": true
          },
          "position": {
            "x": -96,
        ...
        {
          "id": "4393cc5e-1dec-4e72-99c5-62bf20358fea",
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "4393cc5e-1dec-4e72-99c5-62bf20358fea",
