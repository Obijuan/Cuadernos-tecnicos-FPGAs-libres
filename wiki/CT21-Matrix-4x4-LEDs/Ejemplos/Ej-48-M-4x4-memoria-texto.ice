{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "9d47d6d6-119a-4724-9092-1ace77322918",
          "type": "basic.constant",
          "data": {
            "name": "Hz",
            "value": "1",
        ...
        {
          "id": "1976e023-8969-4d83-9b19-77d0de80c947",
          "type": "basic.memory",
          "data": {
            "name": "TEXTO",
            "list": "//-- Mensaje de texto\n0x07  // 'H'\n0x0E  // 'O'\n0x0B  // 'L'\n0x00  // 'A'\n0x55  // ' '\n",
            "local": false,
            "format": 10
          },
          "position": {
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# Ejemplo 48: Matriz 4x4: Memoria de video de texto\n\nMostrar un mensaje almacenado en la memoria de vídeo de texto\n",
            "readonly": true
          },
          "position": {
            "x": -1088,
        ...
        {
          "id": "7c65dae9-7a2a-410f-92f7-577d21d84fdb",
          "type": "basic.info",
          "data": {
            "info": "## MEMORIA DE VIDEO DE TEXTO",
            "readonly": true
          },
          "position": {
            "x": -1072,
        ...
        {
          "id": "982c1541-f426-4485-87aa-ab2889400dad",
        ...
        {
          "id": "a662db67-3c4a-4c24-8f8f-320a93555426",
        ...
        {
          "id": "1d54160b-f981-44c2-b3ef-35f840da7c17",
          "type": "860272bf1c5fdff130c85c003cdda198baa29ad3",
          "position": {
            "x": -752,
            "y": 232
          },
        ...
        {
          "id": "22143102-a039-4eff-8efd-73d9664b69de",
        ...
        {
          "id": "e0a095f5-2d69-465a-a5fc-ae36170a101a",
          "type": "basic.info",
          "data": {
            "info": "Longitud del  \nmensaje",
            "readonly": true
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "1976e023-8969-4d83-9b19-77d0de80c947",
            "port": "memory-out"
          },
          "target": {
            "block": "982c1541-f426-4485-87aa-ab2889400dad",
            "port": "c71c44ac-0500-4eb5-9c1c-4ea21cd78377"
          }
        },
        {
        ...
        {
          "source": {
            "block": "1d54160b-f981-44c2-b3ef-35f840da7c17",
            "port": "3d04c0d9-00ad-448f-9085-08559affd1a4"
          },
          "target": {
            "block": "982c1541-f426-4485-87aa-ab2889400dad",
        ...
        },
        {
          ...
          "target": {
            "block": "a662db67-3c4a-4c24-8f8f-320a93555426",
        ...
        },
        {
          ...
          "target": {
            "block": "1d54160b-f981-44c2-b3ef-35f840da7c17",
            "port": "dc2d8a61-8386-48eb-bef0-c639bb39c0cc"
          },
          "size": 3
        },
        {
          "source": {
            "block": "9d47d6d6-119a-4724-9092-1ace77322918",
            "port": "constant-out"
          },
          "target": {
            "block": "22143102-a039-4eff-8efd-73d9664b69de",
  ...
  "dependencies": {
    ...
    "860272bf1c5fdff130c85c003cdda198baa29ad3": {
      "package": {
        "name": "Counter-M-x03",
        "version": "0.6",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "3d04c0d9-00ad-448f-9085-08559affd1a4",
              "type": "basic.output",
              "data": {
                "name": "",
                "virtual": true,
            ...
            {
              "id": "e2ffd2af-6009-49b2-a797-67b91711f004",
              "type": "basic.outputLabel",
              "data": {
                "name": "q",
                "range": "[2:0]",
            ...
            {
              "id": "0b8416f9-7080-4a95-a323-4a6c0f379665",
              "type": "basic.inputLabel",
              "data": {
                "name": "mod",
                "range": "[2:0]",
            ...
            {
              "id": "dc2d8a61-8386-48eb-bef0-c639bb39c0cc",
              "type": "basic.input",
              "data": {
                "name": "mod",
                "virtual": true,
            ...
            {
              "id": "435d9e16-742b-4e62-aec1-201c912c9ef5",
              "type": "basic.outputLabel",
              "data": {
                "name": "q",
                "range": "[2:0]",
            ...
            {
              "id": "eb85f0d8-65c9-417d-b551-bd80fb418324",
              "type": "basic.inputLabel",
              "data": {
                "name": "q",
                "range": "[2:0]",
            ...
            {
              "id": "6b9e11b6-13d0-48fe-b21e-6b671ddd928c",
              "type": "basic.outputLabel",
              "data": {
                "name": "mod",
                "range": "[2:0]",
            ...
            {
              "id": "a31c325a-e16b-4eca-abd5-662d28e94578",
            ...
            {
              "id": "544fb2b6-20a4-4f1a-a0b7-e4ba92b20357",
            ...
            {
              "id": "884aee68-115e-427a-80d3-9a78a0870442",
          ...
          "wires": [
            ...
            },
            {
              ...
              "target": {
                "block": "a31c325a-e16b-4eca-abd5-662d28e94578",
                "port": "ca7c5f10-efb6-43f9-9364-52d751fc0bc6"
              }
            },
            {
            ...
            {
              "source": {
                "block": "884aee68-115e-427a-80d3-9a78a0870442",
                "port": "4e8afe74-8f38-4873-97ee-f7585d99a4aa"
              },
              "target": {
                "block": "50f8ec2e-140b-469d-8ef2-316befafd7e5",
            ...
            {
              "source": {
                "block": "e2ffd2af-6009-49b2-a797-67b91711f004",
                "port": "outlabel"
              },
              "target": {
                "block": "3d04c0d9-00ad-448f-9085-08559affd1a4",
                "port": "in",
                "size": 3
              },
              "size": 3
            ...
            {
              "source": {
                "block": "dc2d8a61-8386-48eb-bef0-c639bb39c0cc",
                "port": "out",
                "size": 3
              },
              "target": {
                "block": "0b8416f9-7080-4a95-a323-4a6c0f379665",
                "port": "inlabel"
              },
              "size": 3
            },
            {
              ...
              "target": {
                "block": "eb85f0d8-65c9-417d-b551-bd80fb418324",
                "port": "inlabel"
              },
              "size": 3
            },
            {
              "source": {
                "block": "435d9e16-742b-4e62-aec1-201c912c9ef5",
                "port": "outlabel"
              },
              "target": {
                "block": "544fb2b6-20a4-4f1a-a0b7-e4ba92b20357",
            ...
            {
              "source": {
                "block": "6b9e11b6-13d0-48fe-b21e-6b671ddd928c",
                "port": "outlabel"
              },
              "target": {
                "block": "884aee68-115e-427a-80d3-9a78a0870442",
