    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# Ejemplo 2: Un LED apagado y parpadeante\n\nHay un **consumidor** (LED) y dos productores: el que geenra el parpadeo y el del estado apagado  \nEste último es el **productor por defecto**",
            "readonly": true
          },
          "position": {
            "x": 288,
