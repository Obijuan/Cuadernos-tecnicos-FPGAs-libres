    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# Ejemplo 1: Un LED parpadeante\n\nHay un recurso, el LED, que es el **consumidor**. Hay un **productor**, el corazón que genera una  \nsecuencia de parpadeo. Ambos se conectan directamente mediante un bus de 1 bit (un cable)",
            "readonly": true
          },
          "position": {
            "x": 256,
        ...
        {
          "id": "e04d85f3-5189-49ee-8980-31e5a91bb5ef",
      ...
      "wires": [
        {
          ...
          "target": {
            "block": "e04d85f3-5189-49ee-8980-31e5a91bb5ef",
