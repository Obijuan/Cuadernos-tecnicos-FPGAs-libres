    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# Ejemplo 11: Inicialización y escritura de datos\n\nCon las 3 primeras pulsación de `SW1` se inicializa el display. Las siguientes hace que se escriba  \nel valor 0xFF en la memoria de video",
            "readonly": true
          },
          "position": {
            "x": 336,
