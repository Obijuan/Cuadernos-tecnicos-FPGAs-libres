{
    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# Ejemplo 13: Selección de columna\n\nCon las 4 primeras pulsación de `SW1` se inicializa el display. Las siguientes hace que se escriba  \nel valor 0xFF en la memoria de video de la página actual. Se establece en la inicialización en una columna determinada  ",
            "readonly": true
          },
          "position": {
            "x": 336,
        ...
        {
          "id": "26eafae3-b8c3-43f1-818b-3f06086c6dd3",
          "type": "f0149aa2b744be8a280cbf51650e2b284e03c1bf",
          "position": {
            "x": 1136,
            "y": 80
          },
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "26eafae3-b8c3-43f1-818b-3f06086c6dd3",
        ...
        },
        {
          ...
          "target": {
            "block": "e238c278-a413-4474-a98b-2e1e048498cb",
            "port": "inlabel"
          }
        },
        {
  ...
  "dependencies": {
    ...
    "f0149aa2b744be8a280cbf51650e2b284e03c1bf": {
      "package": {
