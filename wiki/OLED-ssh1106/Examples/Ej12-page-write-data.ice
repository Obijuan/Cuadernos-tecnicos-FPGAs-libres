  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "3bcb3fa2-b072-4d48-a6ee-eb92d12fc22b",
          "type": "basic.constant",
          "data": {
            "name": "SET_PAGE",
            "value": "'hB1",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# Ejemplo 12: Selección de página\n\nCon las 4 primeras pulsación de `SW1` se inicializa el display. Las siguientes hace que se escriba  \nel valor 0xFF en la memoria de video de la página actual. Se establece en la inicialización la página 1 (0xB1)  ",
            "readonly": true
          },
          "position": {
            "x": 336,
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "3bcb3fa2-b072-4d48-a6ee-eb92d12fc22b",
            "port": "constant-out"
          },
          "target": {
