{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "1367130c-b531-4908-9823-eff55e957fa0",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "range": "[7:0]",
        ...
        {
          "id": "c2642a67-2bc3-41dc-b467-b3edfd8c9be5",
          "type": "basic.input",
          "data": {
            "name": "Boton-1",
            "pins": [
        ...
        {
          "id": "cba617dd-8e85-4853-9062-d97a2e88113b",
        ...
        {
          "id": "deb0fde7-ede2-47af-9654-6201b7b2bd49",
        ...
        {
          "id": "6a2073c9-d8f2-4f83-9d8a-a9434cb2f29b",
          "type": "basic.info",
          "data": {
        ...
        {
          "id": "6eea184a-7322-4684-a7a8-47993a6968ae",
          "type": "basic.info",
          "data": {
            "info": "Copy-x8",
            "readonly": true
      ...
      "wires": [
        {
          "source": {
            "block": "c2642a67-2bc3-41dc-b467-b3edfd8c9be5",
            "port": "out"
          },
          "target": {
            "block": "cba617dd-8e85-4853-9062-d97a2e88113b",
        ...
        },
        {
          ...
          "target": {
            "block": "deb0fde7-ede2-47af-9654-6201b7b2bd49",
        ...
        },
        {
          ...
          "target": {
            "block": "1367130c-b531-4908-9823-eff55e957fa0",
            "port": "in"
          },
          "size": 8
        }
