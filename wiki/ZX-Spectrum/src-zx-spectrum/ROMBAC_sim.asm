; Code for simulations. Diferences vs ROMBAC.asm:
; - Only 16 bytes written to PSRAM (the PSRAM already has the ROM contents during simulations)
; - No big delay between main reset and Z80 reset
