{
    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "## Ejemplo 6: 4+1 niveles de brillo en el LED. Frec: 92Hz\n\nMismo ejemplo 5, pero añadiendo un prescalado de 15 bits  \npara tener un PWM a una frecuencia de 92Hz",
            "readonly": true
          },
          "position": {
            "x": -168,
        ...
        {
          "id": "611b57b5-27e8-495f-b2f4-bea05cb38034",
          "type": "e412e19ab18aca4bfd2433212d3bbe98aa2f6007",
          "position": {
            "x": 360,
            "y": 80
          },
        ...
        {
          "id": "ce19f67b-73fa-4fe5-89b1-ca0f5ee98ced",
          "type": "basic.info",
          "data": {
            "info": "Extraer los dos bits  \nmas significativos",
            "readonly": true
          },
          "position": {
            "x": 352,
        ...
        {
          "id": "c176a8c1-8555-4645-9009-539b74fbdf7e",
        ...
        {
          "id": "a50543f7-80f5-4b06-affd-a9271dc8fd84",
          "type": "ddd06ea3edbe8e3ff0f5f26638ef03d957becd67",
          "position": {
            "x": 168,
            "y": 80
          },
        ...
        {
          "id": "335b9c6e-c2a4-4c97-b00a-f0574d1afa66",
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "611b57b5-27e8-495f-b2f4-bea05cb38034",
            "port": "db8efa61-6dec-4abc-b362-c8c418b71668"
          },
          "target": {
            "block": "ee6f4450-da09-4004-a5f2-3544e9966153",
        ...
        {
          "source": {
            "block": "a50543f7-80f5-4b06-affd-a9271dc8fd84",
            "port": "4b758c96-9b2f-4022-9ea6-24a4a9f9be53"
          },
          "target": {
            "block": "611b57b5-27e8-495f-b2f4-bea05cb38034",
        ...
        {
          "source": {
            "block": "c176a8c1-8555-4645-9009-539b74fbdf7e",
            "port": "3d584b0a-29eb-47af-8c43-c0822282ef05"
          },
          "target": {
            "block": "61d3b28b-e6b5-427f-95ac-04b8f2fb7a5d",
        ...
        {
          "source": {
            "block": "335b9c6e-c2a4-4c97-b00a-f0574d1afa66",
  ...
  "dependencies": {
    ...
    "e412e19ab18aca4bfd2433212d3bbe98aa2f6007": {
      "package": {
        "name": "Extractor-bus-2bits-de-17bits",
        "version": "0.1",
        "description": "Extractor de bus de 2 bits de uno de 17bits",
        "author": "Juan González-Gómez (Obijuan)",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "db8efa61-6dec-4abc-b362-c8c418b71668",
              "type": "basic.output",
              "data": {
                "name": "",
                "range": "[1:0]",
          ...
          "wires": [
            ...
            },
            {
              ...
              "target": {
                "block": "db8efa61-6dec-4abc-b362-c8c418b71668",
                "port": "in"
              },
              "size": 2
            }
    ...
    "ddd06ea3edbe8e3ff0f5f26638ef03d957becd67": {
      "package": {
        "name": "Contador-sistema-basico",
        "version": "0.2",
        "description": "Contador del sistema, de 17 bits",
        "author": "Juan González-Gómez (Obijuan)",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "4b758c96-9b2f-4022-9ea6-24a4a9f9be53",
              "type": "basic.output",
              "data": {
                "name": "",
                "range": "[16:0]",
          ...
          "wires": [
            ...
            },
            {
              ...
              "target": {
                "block": "4b758c96-9b2f-4022-9ea6-24a4a9f9be53",
                "port": "in"
              },
              "size": 17
            }
